...
def main():
    ...
    parser.add_argument(
        "--with-sample-data", action="store_true", help="Insert sample data after creating tables"
    )
    parser.add_argument(
        "--drop-existing", action="store_true", help="Drop existing tables before creating"
    )
