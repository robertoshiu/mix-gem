...
function createInitialState() {
  ...
  return {
    ...
    // Default to playing so the SSR/first-paint button label and aria-pressed
    // match the WCAG 2.2.2 "defaults to playing" design requirement. The page
    // mount-effect immediately calls start() which is idempotent.
    playing: true,
