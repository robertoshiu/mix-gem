...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},766397,e=>{"use strict";var a=e.i(263537);let r="bumpFragmentMainFunctions",i=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["bumpFragmentMainFunctionsWGSL",0,{name:r,shader:i}])},339586,e=>{"use strict";var a=e.i(263537);let r="samplerFragmentDeclaration",i=`#ifdef _DEFINENAME_
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},769226,e=>{"use strict";var a=e.i(263537);e.i(339586);let r="bumpFragmentFunctions",i=`#if defined(BUMP)
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["bumpFragmentFunctionsWGSL",0,{name:r,shader:i}])},588404,e=>{"use strict";var a=e.i(263537);let r="bumpFragment",i=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["bumpFragmentWGSL",0,{name:r,shader:i}])},308742,e=>{"use strict";var a=e.i(263537);e.i(160009),e.i(733570),e.i(129998),e.i(282325),e.i(507534),e.i(339586);let r="samplerFragmentAlternateDeclaration",i=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.i(892118);let n="pbrFragmentSamplersDeclaration",f=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[n]||(a.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.i(144628),e.i(755704),e.i(357351),e.i(562396),e.i(738124),e.i(386497),e.i(120091),e.i(207525),e.i(352483),e.i(803174),e.i(244222),e.i(779910),e.i(203908),e.i(590030),e.i(481519),e.i(843931),e.i(972036),e.i(766397),e.i(769226),e.i(216596),e.i(695623);let t="pbrBlockAlbedoOpacity",o=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;a.ShaderStore.IncludesShadersStoreWGSL[t]||(a.ShaderStore.IncludesShadersStoreWGSL[t]=o);let c="pbrBlockReflectivity",l=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;a.ShaderStore.IncludesShadersStoreWGSL[c]||(a.ShaderStore.IncludesShadersStoreWGSL[c]=l);let d="pbrBlockAmbientOcclusion",s=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;a.ShaderStore.IncludesShadersStoreWGSL[d]||(a.ShaderStore.IncludesShadersStoreWGSL[d]=s);let E="pbrBlockAlphaFresnel",m=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[E]||(a.ShaderStore.IncludesShadersStoreWGSL[E]=m);let S="pbrBlockAnisotropic",R=`#ifdef ANISOTROPIC
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[S]||(a.ShaderStore.IncludesShadersStoreWGSL[S]=R);let v="pbrBlockReflection",u=`#ifdef REFLECTION
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[v]||(a.ShaderStore.IncludesShadersStoreWGSL[v]=u);let C="pbrBlockSheen",p=`#ifdef SHEEN
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[C]||(a.ShaderStore.IncludesShadersStoreWGSL[C]=p);let A="pbrBlockClearcoat",I=`struct clearcoatOutParams
...
return outParams;}
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[A]||(a.ShaderStore.IncludesShadersStoreWGSL[A]=I);let N="pbrBlockIridescence",O=`struct iridescenceOutParams
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[N]||(a.ShaderStore.IncludesShadersStoreWGSL[N]=O);let T="pbrBlockSubSurface",L=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[T]||(a.ShaderStore.IncludesShadersStoreWGSL[T]=L),e.i(212954),e.i(380882),e.i(588404);let _="pbrBlockNormalFinal",M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[_]||(a.ShaderStore.IncludesShadersStoreWGSL[_]=M),e.i(249748);let D="pbrBlockLightmapInit",g=`#ifdef LIGHTMAP
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[D]||(a.ShaderStore.IncludesShadersStoreWGSL[D]=g);let h="pbrBlockGeometryInfo",P=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[h]||(a.ShaderStore.IncludesShadersStoreWGSL[h]=P),e.i(601283);let F="pbrBlockReflectance",b=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[F]||(a.ShaderStore.IncludesShadersStoreWGSL[F]=b);let U="pbrBlockDirectLighting",y=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[U]||(a.ShaderStore.IncludesShadersStoreWGSL[U]=y),e.i(296253);let B="pbrBlockFinalLitComponents",G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[B]||(a.ShaderStore.IncludesShadersStoreWGSL[B]=G);let x="pbrBlockFinalUnlitComponents",V=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;a.ShaderStore.IncludesShadersStoreWGSL[x]||(a.ShaderStore.IncludesShadersStoreWGSL[x]=V);let H="pbrBlockFinalColorComposition",W=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.ShaderStore.IncludesShadersStoreWGSL[H]||(a.ShaderStore.IncludesShadersStoreWGSL[H]=W),e.i(476129),e.i(922446),e.i(54778);let Y="pbrBlockPrePass",X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[Y]||(a.ShaderStore.IncludesShadersStoreWGSL[Y]=X),e.i(328530),e.i(544356);let w="pbrPixelShader",k=`#define PBR_FRAGMENT_SHADER
...
`;a.ShaderStore.ShadersStoreWGSL[w]||(a.ShaderStore.ShadersStoreWGSL[w]=k),e.s(["pbrPixelShaderWGSL",0,{name:w,shader:k}],308742)}]);