...
`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([],916838);let t="openpbrGeometryInfo",o=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],802378);let n="openpbrIblFunctions",f=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([])},69657,e=>{"use strict";var r=e.i(263537);e.i(160009),e.i(733570),e.i(915112),e.i(282325),e.i(507534),e.i(339586),e.i(892118);let i="openpbrFragmentSamplersDeclaration",a=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.i(144628),e.i(755704),e.i(357351),e.i(562396),e.i(738124),e.i(386497),e.i(120091),e.i(207525),e.i(352483),e.i(803174),e.i(244222),e.i(779910),e.i(203908),e.i(590030),e.i(481519),e.i(843931),e.i(972036);let t="openpbrNormalMapFragmentMainFunctions",o=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o);let n="openpbrNormalMapFragmentFunctions",f=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.i(216596),e.i(916838);let s="openpbrConductorReflectance",l=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;r.ShaderStore.IncludesShadersStoreWGSL[s]||(r.ShaderStore.IncludesShadersStoreWGSL[s]=l);let c="openpbrAmbientOcclusionFunctions",m=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;r.ShaderStore.IncludesShadersStoreWGSL[c]||(r.ShaderStore.IncludesShadersStoreWGSL[c]=m),e.i(802378),e.i(935500);let d="openpbrVolumeFunctions",_=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;r.ShaderStore.IncludesShadersStoreWGSL[d]||(r.ShaderStore.IncludesShadersStoreWGSL[d]=_),e.i(212954),e.i(380882);let u="openpbrNormalMapFragment",v=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[u]||(r.ShaderStore.IncludesShadersStoreWGSL[u]=v);let p="openpbrBlockNormalFinal",g=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[p]||(r.ShaderStore.IncludesShadersStoreWGSL[p]=g);let S="openpbrBaseLayerData",E=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[S]||(r.ShaderStore.IncludesShadersStoreWGSL[S]=E),e.i(302887),e.i(587845);let I="openpbrCoatLayerData",h=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[I]||(r.ShaderStore.IncludesShadersStoreWGSL[I]=h);let R="openpbrThinFilmLayerData",T=`#ifdef THIN_FILM
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[R]||(r.ShaderStore.IncludesShadersStoreWGSL[R]=T);let N="openpbrFuzzLayerData",A=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[N]||(r.ShaderStore.IncludesShadersStoreWGSL[N]=A);let b="openpbrAmbientOcclusionData",L=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[b]||(r.ShaderStore.IncludesShadersStoreWGSL[b]=L),e.i(249748);let F="openpbrBackgroundTransmission",C=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[F]||(r.ShaderStore.IncludesShadersStoreWGSL[F]=C);let O="openpbrEnvironmentLighting",D=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[O]||(r.ShaderStore.IncludesShadersStoreWGSL[O]=D);let x="openpbrDirectLightingInit",P=`#ifdef LIGHT{X}
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[x]||(r.ShaderStore.IncludesShadersStoreWGSL[x]=P);let M="openpbrDirectLighting",G=`#ifdef LIGHT{X}
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[M]||(r.ShaderStore.IncludesShadersStoreWGSL[M]=G),e.i(476129),e.i(922446),e.i(54778);let y="openpbrBlockPrePass",W=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[y]||(r.ShaderStore.IncludesShadersStoreWGSL[y]=W),e.i(328530),e.i(544356);let z="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
...
`;r.ShaderStore.ShadersStoreWGSL[z]||(r.ShaderStore.ShadersStoreWGSL[z]=U),e.s(["openpbrPixelShaderWGSL",0,{name:z,shader:U}],69657)}]);