(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,308742,e=>{"use strict";var a=e.i(263537);e.i(160009),e.i(733570),e.i(129998),e.i(282325),e.i(507534),e.i(339586);let r="samplerFragmentAlternateDeclaration",i=`#ifdef _DEFINENAME_
...
`;a.ShaderStore.IncludesShadersStoreWGSL[d]||(a.ShaderStore.IncludesShadersStoreWGSL[d]=s);let E="pbrBlockAlphaFresnel",S=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[E]||(a.ShaderStore.IncludesShadersStoreWGSL[E]=S);let R="pbrBlockAnisotropic",m=`#ifdef ANISOTROPIC
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[R]||(a.ShaderStore.IncludesShadersStoreWGSL[R]=m);let C="pbrBlockReflection",u=`#ifdef REFLECTION
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[C]||(a.ShaderStore.IncludesShadersStoreWGSL[C]=u);let v="pbrBlockSheen",I=`#ifdef SHEEN
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[v]||(a.ShaderStore.IncludesShadersStoreWGSL[v]=I);let A="pbrBlockClearcoat",p=`struct clearcoatOutParams
...
return outParams;}
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[A]||(a.ShaderStore.IncludesShadersStoreWGSL[A]=p);let N="pbrBlockIridescence",O=`struct iridescenceOutParams
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[_]||(a.ShaderStore.IncludesShadersStoreWGSL[_]=M),e.i(249748);let D="pbrBlockLightmapInit",P=`#ifdef LIGHTMAP
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[D]||(a.ShaderStore.IncludesShadersStoreWGSL[D]=P);let F="pbrBlockGeometryInfo",h=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[F]||(a.ShaderStore.IncludesShadersStoreWGSL[F]=h),e.i(601283);let g="pbrBlockReflectance",U=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[g]||(a.ShaderStore.IncludesShadersStoreWGSL[g]=U);let b="pbrBlockDirectLighting",y=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[b]||(a.ShaderStore.IncludesShadersStoreWGSL[b]=y),e.i(296253);let B="pbrBlockFinalLitComponents",G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[B]||(a.ShaderStore.IncludesShadersStoreWGSL[B]=G);let V="pbrBlockFinalUnlitComponents",x=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;a.ShaderStore.IncludesShadersStoreWGSL[V]||(a.ShaderStore.IncludesShadersStoreWGSL[V]=x);let H="pbrBlockFinalColorComposition",W=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.ShaderStore.IncludesShadersStoreWGSL[H]||(a.ShaderStore.IncludesShadersStoreWGSL[H]=W),e.i(476129),e.i(922446),e.i(54778);let Y="pbrBlockPrePass",w=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[Y]||(a.ShaderStore.IncludesShadersStoreWGSL[Y]=w),e.i(328530),e.i(544356);let X="pbrPixelShader",k=`#define PBR_FRAGMENT_SHADER
...
`;a.ShaderStore.ShadersStoreWGSL[X]||(a.ShaderStore.ShadersStoreWGSL[X]=k),e.s(["pbrPixelShaderWGSL",0,{name:X,shader:k}],308742)}]);