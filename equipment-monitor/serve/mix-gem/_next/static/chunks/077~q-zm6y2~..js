...
`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["defaultVertexShader",0,{name:a,shader:o}],606294)},587630,e=>{"use strict";var t=e.i(263537);let r="instancesVertex",i=`#ifdef INSTANCES
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},781801,e=>{"use strict";var t=e.i(263537);let r="clipPlaneVertex",i=`#ifdef CLIPPLANE
...
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["clipPlaneVertex",0,{name:r,shader:i}])},182478,e=>{"use strict";var t=e.i(263537);let r="clipPlaneVertexDeclaration",i=`#ifdef CLIPPLANE
...
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["clipPlaneVertexDeclaration",0,{name:r,shader:i}])},94556,e=>{"use strict";var t=e.i(263537);let r="logDepthVertex",i=`#ifdef LOGARITHMICDEPTH
...
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},294715,e=>{"use strict";var t=e.i(263537);let r="shadowsVertex",i=`#ifdef SHADOWS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["shadowsVertex",0,{name:r,shader:i}])},957479,e=>{"use strict";var t=e.i(263537);let r="lightVxFragmentDeclaration",i=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["lightVxFragmentDeclaration",0,{name:r,shader:i}])},889952,e=>{"use strict";var t=e.i(263537);let r="lightVxUboDeclaration",i=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["lightVxUboDeclaration",0,{name:r,shader:i}])},146259,e=>{"use strict";var t=e.i(263537);let r="vertexColorMixing",i=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[c]||(t.ShaderStore.IncludesShadersStore[c]=d),e.s([],46566);let u="uvVariableDeclaration",p=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;t.ShaderStore.IncludesShadersStore[u]||(t.ShaderStore.IncludesShadersStore[u]=p),e.s([],591573);let m="samplerVertexImplementation",v=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[m]||(t.ShaderStore.IncludesShadersStore[m]=v),e.s([],631130)},983789,e=>{"use strict";var t=e.i(263537);let r="bumpVertexDeclaration",i=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},229082,e=>{"use strict";var t=e.i(263537);let r="pointCloudVertex",i=`#if defined(POINTSIZE) && !defined(WEBGPU)
gl_PointSize=pointSize;
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},413073,e=>{"use strict";var t=e.i(263537);e.i(629238),e.i(997900);let r="defaultUboDeclaration",i=`layout(std140,column_major) uniform;uniform Material
...
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},873146,e=>{"use strict";var t=e.i(263537);let r="backgroundFragmentDeclaration",i=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["backgroundPixelShader",0,{name:n,shader:s}],873146)},932361,e=>{"use strict";var t=e.i(263537);e.i(629238);let r="backgroundUboDeclaration",i=`layout(std140,column_major) uniform;uniform Material
...
return result;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["lightsFragmentFunctionsWGSL",0,{name:r,shader:i}])},516401,e=>{"use strict";var t=e.i(263537);e.i(915112),e.i(314530),e.i(865557),e.i(738124),e.i(590030),e.i(407892),e.i(380244),e.i(13486),e.i(794415),e.i(597792),e.i(244222);let r="openpbrNormalMapVertexDeclaration",i=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[n]||(t.ShaderStore.ShadersStoreWGSL[n]=s),e.s(["openpbrVertexShaderWGSL",0,{name:n,shader:s}],516401)},4118,e=>{"use strict";var t=e.i(263537);e.i(861230);let r="pbrVertexDeclaration",i=`uniform mat4 view;uniform mat4 viewProjection;uniform vec4 vEyePosition;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif
#ifdef ALBEDO
...
`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["pbrVertexShader",0,{name:a,shader:o}],4118)},529413,e=>{"use strict";var t=e.i(263537);e.i(24012),e.i(861230);let r="openpbrVertexDeclaration",i=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["gaussianSplattingVertexShaderWGSL",0,{name:r,shader:i}])},12799,e=>{"use strict";var t=e.i(263537);let r="screenSpaceRayTrace",i=`fn distanceSquared(a: vec2f,b: vec2f)->f32 { 
var temp=a-b; 
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["screenSpaceReflection2BlurCombinerPixelShaderWGSL",0,{name:r,shader:i}])},186207,e=>{"use strict";var t=e.i(263537);let r="mrtFragmentDeclaration",i=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
gl_FragColor=textureCube(textureSampler,vec3(uv,-1.001));
#endif
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["passCubePixelShader",0,{name:r,shader:i}])},3769,e=>{"use strict";var t=e.i(263537);let r="iblVoxelGridPixelShader",i=`var voxel_storage: texture_storage_3d<r8unorm,write>;varying vNormalizedPosition: vec3f;flat varying f_swizzle: i32;@fragment
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["colorPixelShader",0,{name:r,shader:i}])},188709,e=>{"use strict";var t=e.i(263537);e.i(201632),e.i(442357),e.i(424192),e.i(289258);let r="hdrFilteringPixelShader",i=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
uniform float alphaG;uniform samplerCube inputTexture;uniform vec2 vFilteringInfo;uniform float hdrScale;varying vec3 direction;void main() {vec3 color=radiance(alphaG,inputTexture,direction,vFilteringInfo);gl_FragColor=vec4(color*hdrScale,1.0);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["hdrFilteringPixelShader",0,{name:r,shader:i}])},24163,e=>{"use strict";var t=e.i(263537);e.i(201632),e.i(442357),e.i(424192),e.i(289258);let r="hdrIrradianceFilteringPixelShader",i=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["glowMapMergePixelShaderWGSL",0,{name:r,shader:i}])},748582,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingBilateralBlurPixelShader",i=`uniform sampler2D textureSampler;uniform int maxFilterSize;uniform vec2 blurDir;uniform float projectedParticleConstant;uniform float depthThreshold;varying vec2 vUV;void main(void) {float depth=textureLod(textureSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(vec3(depth),1.);return;}
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingBilateralBlurPixelShader",0,{name:r,shader:i}])},302054,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingParticleDepthPixelShader",i=`uniform projection: mat4x4f;varying uv: vec2f;varying viewPos: vec3f;varying sphereRadius: f32;
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingParticleDepthPixelShaderWGSL",0,{name:r,shader:i}])},252675,e=>{"use strict";var t=e.i(263537);e.i(738124),e.i(590030),e.i(12799);let r="screenSpaceReflection2PixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["screenSpaceReflection2PixelShaderWGSL",0,{name:r,shader:i}])},62766,e=>{"use strict";var t=e.i(263537);let r="screenSpaceRayTrace",i=`float distanceSquared(vec2 a,vec2 b) { a-=b; return dot(a,a); }
#ifdef SSRAYTRACE_SCREENSPACE_DEPTH
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["linePixelShaderWGSL",0,{name:r,shader:i}])},848458,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="copyTextureToTexturePixelShader",i=`uniform conversion: f32;
#ifndef NO_SAMPLER
...
#include<vertexColorMixing>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["colorVertexShader",0,{name:r,shader:i}])},565594,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(127010),e.i(141687),e.i(358759);let r="outlinePixelShader",i=`#ifdef LOGARITHMICDEPTH
#extension GL_EXT_frag_depth : enable
#endif
uniform vec4 color;
#ifdef ALPHATEST
...
gl_FragColor=color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["outlinePixelShader",0,{name:r,shader:i}])},369488,e=>{"use strict";var t=e.i(263537);let r="iblGenerateVoxelMipPixelShader",i=`precision highp float;precision highp sampler3D;varying vec2 vUV;uniform sampler3D srcMip;uniform int layerNum;void main(void) {ivec3 Coords=ivec3(2)*ivec3(gl_FragCoord.x,gl_FragCoord.y,layerNum);uint tex =
...
<< 7u;glFragColor.rgb=vec3(float(tex)/255.0f,0.0f,0.0f);glFragColor.a=1.0;}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblGenerateVoxelMipPixelShader",0,{name:r,shader:i}])},813299,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="extractHighlightsPixelShader",i=`#include<helperFunctions>
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["geometryPixelShader",0,{name:r,shader:i}])},436916,e=>{"use strict";var t=e.i(263537);e.i(929870),e.i(314530),e.i(738124),e.i(407892),e.i(380244),e.i(13486),e.i(794415),e.i(865557),e.i(597792),e.i(553893),e.i(349e3),e.i(158271);let r="lightVxFragmentDeclaration",i=`#ifdef LIGHT{X}
...
`;t.ShaderStore.ShadersStoreWGSL[a]||(t.ShaderStore.ShadersStoreWGSL[a]=o),e.s(["defaultVertexShaderWGSL",0,{name:a,shader:o}],436916)},637012,e=>{"use strict";var t=e.i(263537);let r="fxaaPixelShader",i=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
gl_FragColor=TEXTUREFUNC(textureSampler,posM,0.0);
#endif
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fxaaPixelShader",0,{name:r,shader:i}])},831002,e=>{"use strict";var t=e.i(263537);let r="ssao2PixelShader",i=`precision highp float;uniform sampler2D textureSampler;varying vec2 vUV;
#ifdef SSAO
...
gl_FragColor=vec4((colorSum/kernelWeight).rgb,1);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["convolutionPixelShader",0,{name:r,shader:i}])},530324,e=>{"use strict";var t=e.i(263537);e.i(738124),e.i(120091),e.i(590030),e.i(481519);let r="hdrIrradianceFilteringPixelShader",i=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
...
#endif
);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["hdrIrradianceFilteringPixelShaderWGSL",0,{name:r,shader:i}])},37053,e=>{"use strict";var t=e.i(353679),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.sound=this.registerDataInput("sound",r.RichTypeAny)}_execute(e,t){let r=this.sound.getValue(e);if(!r){this._reportError(e,"No sound provided"),this.out._activateSignal(e);return}r.stop(),this.out._activateSignal(e)}getClassName(){return"FlowGraphStopSoundBlock"}}(0,i.RegisterClass)("FlowGraphStopSoundBlock",a),e.s(["FlowGraphStopSoundBlock",0,a])},176056,e=>{"use strict";var t=e.i(353679),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.sound=this.registerDataInput("sound",r.RichTypeAny)}_execute(e,t){let r=this.sound.getValue(e);if(!r){this._reportError(e,"No sound provided"),this.out._activateSignal(e);return}5===r.state?r.resume():(2===r.state||3===r.state)&&r.pause(),this.out._activateSignal(e)}getClassName(){return"FlowGraphPauseSoundBlock"}}(0,i.RegisterClass)("FlowGraphPauseSoundBlock",a),e.s(["FlowGraphPauseSoundBlock",0,a])},259652,e=>{"use strict";var t=e.i(263537);e.i(755704),e.i(562396),e.i(212954),e.i(922446);let r="colorPixelShader",i=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
#define VERTEXCOLOR
varying vColor: vec4f;
#else
uniform color: vec4f;
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingStandardBlurPixelShader",0,{name:r,shader:i}])},291678,e=>{"use strict";var t=e.i(263537);let r="boundingBoxRendererPixelShader",i=`uniform color: vec4f;
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {
#define CUSTOM_FRAGMENT_MAIN_BEGIN
fragmentOutputs.color=uniforms.color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["boundingBoxRendererPixelShaderWGSL",0,{name:r,shader:i}])},865820,e=>{"use strict";var t=e.i(263537);let r="lensFlareVertexShader",i=`attribute vec2 position;uniform mat4 viewportMatrix;varying vec2 vUV;const vec2 madd=vec2(0.5,0.5);
#define CUSTOM_VERTEX_DEFINITIONS
void main(void) {
#define CUSTOM_VERTEX_MAIN_BEGIN
vUV=position*madd+madd;gl_Position=viewportMatrix*vec4(position,0.0,1.0);
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lensFlareVertexShader",0,{name:r,shader:i}])},463195,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererMaskerPixelShader",i=`varying vUV: vec2f;@fragment
fn main(input: FragmentInputs)->FragmentOutputs {fragmentOutputs.color= vec4f(1.0,1.0,1.0,1.0);}
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["meshUVSpaceRendererMaskerPixelShaderWGSL",0,{name:r,shader:i}])},354754,e=>{"use strict";var t=e.i(263537);let r="lensFlarePixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec4 color;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) {
#define CUSTOM_FRAGMENT_MAIN_BEGIN
vec4 baseColor=texture2D(textureSampler,vUV);gl_FragColor=baseColor*color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lensFlarePixelShader",0,{name:r,shader:i}])},846456,e=>{"use strict";var t=e.i(263537);e.i(24012),e.i(629238),e.i(367959);let r="lightProxyVertexShader",i=`attribute vec3 position;flat varying vec2 vLimits;flat varying highp uint vMask;
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lightProxyVertexShader",0,{name:r,shader:i}])},295803,e=>{"use strict";var t=e.i(263537);let r="minmaxReduxPixelShader",i=`varying vUV: vec2f;var textureSampler: texture_2d<f32>;
#if defined(INITIAL)
...
fragmentOutputs.color=baseColor;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["particlesPixelShaderWGSL",0,{name:r,shader:i}])},614157,e=>{"use strict";var t=e.i(263537);let r="iblCdfDebugPixelShader",i=`precision highp samplerCube;
#define PI 3.1415927
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblCdfDebugPixelShader",0,{name:r,shader:i}])},224234,e=>{"use strict";var t=e.i(263537);e.i(201632);let r="iblScaledLuminancePixelShader",i=`precision highp sampler2D;precision highp samplerCube;
#include<helperFunctions>
varying vec2 vUV;
#ifdef IBL_USE_CUBE_MAP
uniform samplerCube iblSource;
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[a]||(t.ShaderStore.ShadersStoreWGSL[a]=o),e.s(["spritesPixelShaderWGSL",0,{name:a,shader:o}],584622)},808576,e=>{"use strict";var t=e.i(263537);e.i(624154),e.i(568039),e.i(298378),e.i(369136),e.i(880779),e.i(675406),e.i(610460),e.i(587630),e.i(761523),e.i(479126);let r="meshUVSpaceRendererVertexShader",i=`precision highp float;attribute vec3 position;attribute vec3 normal;attribute vec2 uv;uniform mat4 projMatrix;varying vec2 vDecalTC;
#include<bonesDeclaration>
#include<bakedVertexAnimationDeclaration>
#include<morphTargetsVertexGlobalDeclaration>
#include<morphTargetsVertexDeclaration>[0..maxSimultaneousMorphTargets]
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["layerPixelShader",0,{name:r,shader:i}])},574392,e=>{"use strict";var t=e.i(263537);e.i(880779),e.i(587630);let r="greasedLineVertexShader",i=`precision highp float;
#include<instancesDeclaration>
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["greasedLineVertexShader",0,{name:r,shader:i}])},933678,e=>{"use strict";var t=e.i(263537);e.i(201632);let r="iblIcdfPixelShader",i=`precision highp sampler2D;
#include<helperFunctions>
varying vec2 vUV;
#ifdef IBL_USE_CUBE_MAP
uniform samplerCube iblSource;
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblIcdfPixelShader",0,{name:r,shader:i}])},752114,e=>{"use strict";var t=e.i(263537);e.i(738124),e.i(755704),e.i(212954);let r="glowMapGenerationPixelShader",i=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
#include<helperFunctions>
#endif
#ifdef DIFFUSE
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["screenSpaceReflection2BlurPixelShaderWGSL",0,{name:r,shader:i}])},49256,e=>{"use strict";var t=e.i(263537);e.i(201632),e.i(261937),e.i(141687);let r="glowMapGenerationPixelShader",i=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
#include<helperFunctions>
#endif
#ifdef DIFFUSE
...
`;t.ShaderStore.ShadersStoreWGSL[a]||(t.ShaderStore.ShadersStoreWGSL[a]=o),e.s(["gaussianSplattingPixelShaderWGSL",0,{name:a,shader:o}],146032)},835845,e=>{"use strict";var t=e.i(263537);e.i(182478),e.i(30653),e.i(127010),e.i(781801),e.i(313976),e.i(94556);let r="particlesVertexShader",i=`attribute vec3 position;attribute vec4 color;attribute float angle;attribute vec2 size;
#ifdef ANIMATESHEET
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["meshUVSpaceRendererPixelShader",0,{name:r,shader:i}])},593093,e=>{"use strict";var t=e.i(263537);let r="iblGenerateVoxelMipPixelShader",i=`varying vUV: vec2f;var srcMip: texture_3d<f32>;uniform layerNum: i32;@fragment
...
fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,vec3f(uv,-1.001));
#endif
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["passCubePixelShaderWGSL",0,{name:r,shader:i}])},475086,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererFinaliserPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["outlineVertexShaderWGSL",0,{name:r,shader:i}])},847693,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(127010),e.i(190688),e.i(358759),e.i(313119);let r="gaussianSplattingFragmentDeclaration",i=`vec4 gaussianColor(vec4 inColor)
...
}`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["shadowMapPixelShader",0,{name:n,shader:s}],611061)},710936,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingRenderPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
#define IOR 1.333
#define ETA 1.0/IOR
#define F0 0.02
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingRenderPixelShader",0,{name:r,shader:i}])},117821,e=>{"use strict";var t=e.i(263537);e.i(201632);let r="copyTextureToTexturePixelShader",i=`uniform float conversion;uniform sampler2D textureSampler;uniform float lodLevel;varying vec2 vUV;
#include<helperFunctions>
void main(void) 
{
#ifdef NO_SAMPLER
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["copyTextureToTexturePixelShader",0,{name:r,shader:i}])},169418,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingParticleDepthVertexShader",i=`attribute position: vec3f;attribute offset: vec2f;uniform view: mat4x4f;uniform projection: mat4x4f;uniform size: vec2f;varying uv: vec2f;varying viewPos: vec3f;varying sphereRadius: f32;
#ifdef FLUIDRENDERING_VELOCITY
...
#endif
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblVoxelGridVertexShader",0,{name:r,shader:i}])},582914,e=>{"use strict";var t=e.i(263537);e.i(243400),e.i(561525);let r="lightProxyVertexShader",i=`attribute position: vec3f;flat varying vOffset: u32;flat varying vMask: u32;
#include<sceneUboDeclaration>
...
fragmentOutputs.color= vec4f((colorSum/kernelWeight).rgb,1);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["convolutionPixelShaderWGSL",0,{name:r,shader:i}])},387127,e=>{"use strict";var t=e.i(263537);e.i(407892),e.i(380244),e.i(585817),e.i(945868),e.i(13486),e.i(988389),e.i(431235),e.i(300889),e.i(398879),e.i(92372);let r="pickingVertexShader",i=`attribute position: vec3f;
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["pickingVertexShaderWGSL",0,{name:r,shader:i}])},101868,e=>{"use strict";var t=e.i(263537);e.i(201632),e.i(442357),e.i(424192),e.i(289258);let r="iblDominantDirectionPixelShader",i=`precision highp sampler2D;precision highp samplerCube;
#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
...
lightDir/=float(NUM_SAMPLES);gl_FragColor=vec4(lightDir,1.0);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblDominantDirectionPixelShader",0,{name:r,shader:i}])},851332,e=>{"use strict";var t=e.i(263537);e.i(755704),e.i(357351),e.i(212954),e.i(476129);let r="outlinePixelShader",i=`uniform color: vec4f;
#ifdef ALPHATEST
...
fragmentOutputs.color=uniforms.color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["outlinePixelShaderWGSL",0,{name:r,shader:i}])},980083,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="layerPixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform color: vec4f;
#include<helperFunctions>
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["layerPixelShaderWGSL",0,{name:r,shader:i}])},521565,e=>{"use strict";var t=e.i(263537);let r="circleOfConfusionPixelShader",i=`varying vUV: vec2f;var depthSamplerSampler: sampler;var depthSampler: texture_2d<f32>;
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["circleOfConfusionPixelShaderWGSL",0,{name:r,shader:i}])},78291,e=>{"use strict";var t=e.i(263537);let r="rsmFullGlobalIlluminationPixelShader",i=`/**
...
discard;}}
#endif
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["minmaxReduxPixelShader",0,{name:r,shader:i}])},745273,e=>{"use strict";var t=e.i(263537);e.i(13486),e.i(349e3),e.i(243400),e.i(706568),e.i(357351),e.i(300889),e.i(84318),e.i(505913);let r="lineVertexShader",i=`#define ADDITIONAL_VERTEX_DECLARATION
#include<instancesDeclaration>
#include<clipPlaneVertexDeclaration>
#include<sceneUboDeclaration>
#include<meshUboDeclaration>
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["lineVertexShaderWGSL",0,{name:r,shader:i}])},270161,e=>{"use strict";var t=e.i(263537);let r="iblShadowSpatialBlurPixelShader",i=`#define PI 3.1415927
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["ssaoCombinePixelShaderWGSL",0,{name:r,shader:i}])},737331,e=>{"use strict";var t=e.i(868738),r=e.i(774685),i=e.i(916624);class a extends t.FlowGraphEventBlock{constructor(e){super(e),this.sound=this.registerDataInput("sound",i.RichTypeAny)}_preparePendingTasks(e){let t=this.sound.getValue(e);if(!t)return void this._reportError(e,"No sound provided for sound-ended event");let r=t.onEndedObservable.add(()=>{this._execute(e)});e._setExecutionVariable(this,"_soundEndedObserver",r),e._setExecutionVariable(this,"_subscribedSound",t)}_executeEvent(e,t){return!0}_cancelPendingTasks(e){let t=e._getExecutionVariable(this,"_soundEndedObserver",null),r=e._getExecutionVariable(this,"_subscribedSound",null);t&&r&&r.onEndedObservable.remove(t),e._setExecutionVariable(this,"_soundEndedObserver",null),e._setExecutionVariable(this,"_subscribedSound",null)}getClassName(){return"FlowGraphSoundEndedEventBlock"}}(0,r.RegisterClass)("FlowGraphSoundEndedEventBlock",a),e.s(["FlowGraphSoundEndedEventBlock",0,a])},877693,e=>{"use strict";var t=e.i(263537);e.i(624154),e.i(568039),e.i(298378),e.i(369136),e.i(182478),e.i(880779),e.i(127010),e.i(675406),e.i(610460),e.i(587630),e.i(761523),e.i(479126),e.i(781801),e.i(94556);let r="outlineVertexShader",i=`attribute vec3 position;attribute vec3 normal;
#include<bonesDeclaration>
#include<bakedVertexAnimationDeclaration>
#include<morphTargetsVertexGlobalDeclaration>
#include<morphTargetsVertexDeclaration>[0..maxSimultaneousMorphTargets]
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["geometryVertexShaderWGSL",0,{name:r,shader:i}])},165320,e=>{"use strict";var t=e.i(263537);e.i(201632);let r="iblShadowVoxelTracingPixelShader",i=`precision highp sampler2D;precision highp sampler3D;
#include<helperFunctions>
varying vec2 vUV;
#define DISABLE_UNIFORMITY_ANALYSIS
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["geometryPixelShaderWGSL",0,{name:r,shader:i}])},52165,e=>{"use strict";var t=e.i(263537);e.i(579618),e.i(738124),e.i(216596),e.i(144628),e.i(507534),e.i(393484),e.i(803174),e.i(352483),e.i(357351),e.i(755704),e.i(562396);let r="intersectionFunctions",i=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lodCubePixelShader",0,{name:r,shader:i}])},140200,e=>{"use strict";var t=e.i(353679),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.animationToPause=this.registerDataInput("animationToPause",r.RichTypeAny)}_execute(e){this.animationToPause.getValue(e).pause(),this.out._activateSignal(e)}getClassName(){return"FlowGraphPauseAnimationBlock"}}(0,i.RegisterClass)("FlowGraphPauseAnimationBlock",a),e.s(["FlowGraphPauseAnimationBlock",0,a])},452475,e=>{"use strict";var t=e.i(263537);let r="iblShadowDebugPixelShader",i=`#ifdef GL_ES
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["motionBlurPixelShader",0,{name:r,shader:i}])},104396,e=>{"use strict";var t=e.i(263537);let r="rsmGlobalIlluminationPixelShader",i=`/**
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["rsmGlobalIlluminationPixelShader",0,{name:r,shader:i}])},564919,e=>{"use strict";var t=e.i(263537);let r="iblShadowAccumulationPixelShader",i=`varying vUV: vec2f;uniform accumulationParameters: vec4f;
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[i]||(t.ShaderStore.ShadersStore[i]=a),e.s(["kernelBlurVertexShader",0,{name:i,shader:a}],308552)},734062,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingParticleThicknessVertexShader",i=`attribute position: vec3f;attribute offset: vec2f;uniform view: mat4x4f;uniform projection: mat4x4f;uniform size: vec2f;varying uv: vec2f;@vertex
fn main(input: VertexInputs)->FragmentInputs {var cornerPos: vec3f=vec3f(
vec2f(vertexInputs.offset.x-0.5,vertexInputs.offset.y-0.5)*uniforms.size,
0.0
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingParticleThicknessVertexShaderWGSL",0,{name:r,shader:i}])},102174,e=>{"use strict";var t=e.i(263537);let r="vrDistortionCorrectionPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["vrDistortionCorrectionPixelShaderWGSL",0,{name:r,shader:i}])},778896,e=>{"use strict";var t=e.i(263537);let r="pickingPixelShader",i=`#if defined(INSTANCES)
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["pickingPixelShader",0,{name:r,shader:i}])},316109,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="iblScaledLuminancePixelShader",i=`#include<helperFunctions>
#ifdef IBL_USE_CUBE_MAP
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fxaaVertexShader",0,{name:r,shader:i}])},907099,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(346145),e.i(141687);let r="depthPixelShader",i=`#ifdef ALPHATEST
varying vec2 vUV;uniform sampler2D diffuseSampler;
#endif
#include<clipPlaneFragmentDeclaration>
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["particlesPixelShader",0,{name:r,shader:i}])},78938,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingParticleDepthPixelShader",i=`uniform mat4 projection;varying vec2 uv;varying vec3 viewPos;varying float sphereRadius;
#ifdef FLUIDRENDERING_VELOCITY
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingStandardBlurPixelShaderWGSL",0,{name:r,shader:i}])},266104,e=>{"use strict";var t=e.i(263537);let r="circleOfConfusionPixelShader",i=`uniform sampler2D depthSampler;varying vec2 vUV;
#ifndef COC_DEPTH_NOT_NORMALIZED
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["circleOfConfusionPixelShader",0,{name:r,shader:i}])},15530,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(127010),e.i(358759),e.i(141687);let r="linePixelShader",i=`#include<clipPlaneFragmentDeclaration>
uniform vec4 color;
#ifdef LOGARITHMICDEPTH
#extension GL_EXT_frag_depth : enable
#endif
...
gl_FragColor=color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["linePixelShader",0,{name:r,shader:i}])},185397,e=>{"use strict";var t=e.i(263537);e.i(407892),e.i(380244),e.i(585817),e.i(945868),e.i(13486),e.i(988389),e.i(431235),e.i(300889),e.i(398879),e.i(92372);let r="meshUVSpaceRendererVertexShader",i=`attribute position: vec3f;attribute normal: vec3f;attribute uv: vec2f;uniform projMatrix: mat4x4f;varying vDecalTC: vec2f;
#include<bonesDeclaration>
#include<bakedVertexAnimationDeclaration>
#include<morphTargetsVertexGlobalDeclaration>
#include<morphTargetsVertexDeclaration>[0..maxSimultaneousMorphTargets]
...
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},464291,e=>{"use strict";var t=e.i(263537);let r="shadowMapFragment",i=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fxaaVertexShaderWGSL",0,{name:r,shader:i}])},646614,e=>{"use strict";var t=e.i(916624),r=e.i(353679),i=e.i(774685);class a extends r.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.count=this.registerDataInput("count",t.RichTypeNumber),this.reset=this._registerSignalInput("reset"),this.currentCount=this.registerDataOutput("currentCount",t.RichTypeNumber)}_execute(e,t){if(t===this.reset)return void e._setExecutionVariable(this,"debounceCount",0);let r=this.count.getValue(e),i=e._getExecutionVariable(this,"debounceCount",0)+1;this.currentCount.setValue(i,e),e._setExecutionVariable(this,"debounceCount",i),i>=r&&(this.out._activateSignal(e),e._setExecutionVariable(this,"debounceCount",0))}getClassName(){return"FlowGraphDebounceBlock"}}(0,i.RegisterClass)("FlowGraphDebounceBlock",a),e.s(["FlowGraphDebounceBlock",0,a])},319240,197003,549030,e=>{"use strict";var t=e.i(263537);let r="gaussianSplattingVertexDeclaration";t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;"),e.s([],319240),e.i(629238),e.i(997900);let i="gaussianSplattingUboDeclaration",a=`#include<sceneUboDeclaration>
#include<meshUboDeclaration>
...
fragmentOutputs.color=textureSampleLevel(textureSampler,textureSamplerSampler,posM,0.0);
#endif
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fxaaPixelShaderWGSL",0,{name:r,shader:i}])},687977,e=>{"use strict";var t=e.i(263537);let r="iblCdfDebugPixelShader",i=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["iblCdfDebugPixelShaderWGSL",0,{name:r,shader:i}])},837438,e=>{"use strict";var t=e.i(263537);let r="lineVertexDeclaration",i=`uniform mat4 viewProjection;
#define ADDITIONAL_VERTEX_DECLARATION
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["lineVertexShader",0,{name:n,shader:s}],837438)},717234,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererFinaliserVertexShader",i=`attribute position: vec3f;attribute uv: vec2f;uniform worldViewProjection: mat4x4f;varying vUV: vec2f;@vertex
...
`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["boundingBoxRendererVertexShader",0,{name:a,shader:o}],436813)},355369,e=>{"use strict";var t=e.i(263537);let r="depthOfFieldMergePixelShader",i=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
#define TEXTUREFUNC(s,c,lod) texture2DLodEXT(s,c,lod)
#else
#define TEXTUREFUNC(s,c,bias) texture2D(s,c,bias)
#endif
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["lodCubePixelShaderWGSL",0,{name:r,shader:i}])},856953,e=>{"use strict";var t=e.i(263537);let r="tonemapPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float _ExposureAdjustment;
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lodPixelShader",0,{name:r,shader:i}])},859826,e=>{"use strict";var t=e.i(263537);let r="bloomMergePixelShader",i=`uniform sampler2D textureSampler;uniform sampler2D bloomBlur;varying vec2 vUV;uniform float bloomWeight;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void)
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["areaLightTextureProcessingPixelShader",0,{name:r,shader:i}])},649818,e=>{"use strict";var t=e.i(263537);let r="hdrFilteringVertexShader",i=`attribute position: vec2f;varying direction: vec3f;uniform up: vec3f;uniform right: vec3f;uniform front: vec3f;
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
fn main(input : VertexInputs)->FragmentInputs {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["hdrFilteringVertexShaderWGSL",0,{name:r,shader:i}])},529653,e=>{"use strict";var t=e.i(263537);let r="iblCdfxPixelShader",i=`#define PI 3.1415927
...
fragmentOutputs.color= vec4f( vec3f(cdfx),1.0);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["iblCdfxPixelShaderWGSL",0,{name:r,shader:i}])},109742,e=>{"use strict";var t=e.i(263537);let r="layerVertexShader",i=`attribute position: vec2f;uniform scale: vec2f;uniform offset: vec2f;uniform textureMatrix: mat4x4f;varying vUV: vec2f;const madd: vec2f= vec2f(0.5,0.5);
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
fn main(input : VertexInputs)->FragmentInputs {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
fragmentOutputs.color=baseColor;}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["glowBlurPostProcessPixelShaderWGSL",0,{name:r,shader:i}])},103446,e=>{"use strict";var t=e.i(263537);let r="iblShadowSpatialBlurPixelShader",i=`precision highp sampler2D;
#define PI 3.1415927
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["layerVertexShader",0,{name:r,shader:i}])},916052,e=>{"use strict";var t=e.i(263537);let r="pickingPixelShader",i=`#if defined(INSTANCES)
flat varying vMeshID: f32;
#else
uniform meshID: f32;
#endif
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["pickingPixelShaderWGSL",0,{name:r,shader:i}])},844037,e=>{"use strict";var t=e.i(263537);let r="lensFlarePixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform color: vec4f;
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {
#define CUSTOM_FRAGMENT_MAIN_BEGIN
...
#endif
#include<clipPlaneVertex>
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["glowMapGenerationVertexShader",0,{name:r,shader:i}])},348199,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingRenderPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
#define IOR 1.333
#define ETA 1.0/IOR
#define F0 0.02
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingRenderPixelShaderWGSL",0,{name:r,shader:i}])},565848,e=>{"use strict";var t=e.i(263537);e.i(201632),e.i(424192),e.i(62766);let r="screenSpaceReflection2PixelShader",i=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
#define TEXTUREFUNC(s,c,lod) texture2DLodEXT(s,c,lod)
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["screenSpaceReflection2PixelShader",0,{name:r,shader:i}])},138464,e=>{"use strict";var t=e.i(440163),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphBlock{constructor(e){super(e),this.condition=this.registerDataInput("condition",r.RichTypeBoolean),this.onTrue=this.registerDataInput("onTrue",r.RichTypeAny),this.onFalse=this.registerDataInput("onFalse",r.RichTypeAny),this.output=this.registerDataOutput("output",r.RichTypeAny)}_updateOutputs(e){let t=this.condition.getValue(e);this.output.setValue(t?this.onTrue.getValue(e):this.onFalse.getValue(e),e)}getClassName(){return"FlowGraphConditionalBlock"}}(0,i.RegisterClass)("FlowGraphConditionalBlock",a),e.s(["FlowGraphConditionalDataBlock",0,a])},529460,e=>{"use strict";var t=e.i(263537);let r="rsmFullGlobalIlluminationPixelShader",i=`/**
* The implementation is a direct application of the formula found in http:
*/
...
#endif
gl_FragColor.rgb=computeIndirect(positionW,normalW);gl_FragColor.a=1.0;}
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["rsmFullGlobalIlluminationPixelShader",0,{name:r,shader:i}])},226859,e=>{"use strict";var t=e.i(263537);let r="chromaticAberrationPixelShader",i=`uniform sampler2D textureSampler; 
...
#endif
#endif
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["depthPixelShaderWGSL",0,{name:r,shader:i}])},170755,e=>{"use strict";var t=e.i(263537);let r="rsmGlobalIlluminationPixelShader",i=`/**
* The implementation is an application of the formula found in http:
* For better results,it also adds a random (noise) rotation to the RSM samples (the noise artifacts are easier to remove than the banding artifacts).
*/
...
#endif
fragmentOutputs.color=vec4f(computeIndirect(positionW,normalW),1.0);}
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["rsmGlobalIlluminationPixelShaderWGSL",0,{name:r,shader:i}])},151812,e=>{"use strict";var t=e.i(263537);e.i(319240),e.i(197003),e.i(182478),e.i(30653),e.i(127010),e.i(201632),e.i(549030),e.i(781801),e.i(313976),e.i(94556);let r="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
#ifdef LOGARITHMICDEPTH
#extension GL_EXT_frag_depth : enable
#endif
#include<clipPlaneVertexDeclaration>
...
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var screen_color: vec4f=textureSample(textureSampler,textureSamplerSampler,input.vUV);fragmentOutputs.color=sampleAs3DTexture(screen_color.rgb,SLICE_COUNT);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["colorCorrectionPixelShaderWGSL",0,{name:r,shader:i}])},744634,e=>{"use strict";var t=e.i(440163),r=e.i(916624),i=e.i(774685),a=e.i(906115);class o extends t.FlowGraphBlock{constructor(e){super(e),this.config=e,this.output=this.registerDataOutput("output",(0,r.getRichTypeFromValue)(e.value))}_updateOutputs(e){this.output.setValue(this.config.value,e)}getClassName(){return"FlowGraphConstantBlock"}serialize(e={},t=a.defaultValueSerializationFunction){super.serialize(e),t("value",this.config.value,e.config)}}(0,i.RegisterClass)("FlowGraphConstantBlock",o),e.s(["FlowGraphConstantBlock",0,o])},735939,e=>{"use strict";var t=e.i(440163),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphBlock{constructor(e){super(e),this.body=this.registerDataInput("body",r.RichTypeAny),this.mass=this.registerDataOutput("mass",r.RichTypeNumber),this.centerOfMass=this.registerDataOutput("centerOfMass",r.RichTypeVector3),this.inertia=this.registerDataOutput("inertia",r.RichTypeVector3)}_updateOutputs(e){let t=this.body.getValue(e);if(!t)return;let r=t.getMassProperties();void 0!==r.mass&&this.mass.setValue(r.mass,e),r.centerOfMass&&this.centerOfMass.setValue(r.centerOfMass,e),r.inertia&&this.inertia.setValue(r.inertia,e)}getClassName(){return"FlowGraphGetPhysicsMassPropertiesBlock"}}(0,i.RegisterClass)("FlowGraphGetPhysicsMassPropertiesBlock",a),e.s(["FlowGraphGetPhysicsMassPropertiesBlock",0,a])},623321,e=>{"use strict";var t=e.i(868738),r=e.i(916624),i=e.i(774685),a=e.i(711835);class o extends t.FlowGraphEventBlock{constructor(e){super(e),this.type="PointerOut",this.pointerId=this.registerDataOutput("pointerId",r.RichTypeNumber),this.targetMesh=this.registerDataInput("targetMesh",r.RichTypeAny,e?.targetMesh),this.meshOutOfPointer=this.registerDataOutput("meshOutOfPointer",r.RichTypeAny)}_executeEvent(e,t){let r=this.targetMesh.getValue(e);return this.meshOutOfPointer.setValue(t.mesh,e),this.pointerId.setValue(t.pointerId,e),!(!(t.over&&(0,a._IsDescendantOf)(t.mesh,r))&&(t.mesh===r||(0,a._IsDescendantOf)(t.mesh,r)))||(this._execute(e),!this.config?.stopPropagation)}_preparePendingTasks(e){}_cancelPendingTasks(e){}getClassName(){return"FlowGraphPointerOutEventBlock"}}(0,i.RegisterClass)("FlowGraphPointerOutEventBlock",o),e.s(["FlowGraphPointerOutEventBlock",0,o])},375941,e=>{"use strict";var t=e.i(263537);let r="ssao2PixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;
#ifdef SSAO
...
#endif
#endif
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["ssao2PixelShaderWGSL",0,{name:r,shader:i}])},917304,e=>{"use strict";var t=e.i(263537);e.i(624154),e.i(568039),e.i(298378),e.i(369136),e.i(201632),e.i(24012),e.i(773111);let r="shadowMapVertexDeclaration",i=`#include<sceneVertexDeclaration>
...
#endif
#include<clipPlaneVertex>
}`;t.ShaderStore.ShadersStore[c]||(t.ShaderStore.ShadersStore[c]=d),e.s(["shadowMapVertexShader",0,{name:c,shader:d}],917304)},480518,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="rgbdDecodePixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;
#include<helperFunctions>
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
...
var view: mat3x3f= mat3x3f(uniforms.up,uniforms.right,uniforms.front);vertexOutputs.direction=view*vec3f(vertexInputs.position,1.0);vertexOutputs.position= vec4f(vertexInputs.position,0.0,1.0);
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["hdrIrradianceFilteringVertexShaderWGSL",0,{name:r,shader:i}])},975663,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererPixelShader",i=`varying vDecalTC: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;@fragment
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["meshUVSpaceRendererPixelShaderWGSL",0,{name:r,shader:i}])},657921,e=>{"use strict";var t=e.i(868738),r=e.i(774685);class i extends t.FlowGraphEventBlock{constructor(){super(...arguments),this.initPriority=-1,this.type="SceneReady"}_executeEvent(e,t){return this._execute(e),!0}_preparePendingTasks(e){}_cancelPendingTasks(e){}getClassName(){return"FlowGraphSceneReadyEventBlock"}}(0,r.RegisterClass)("FlowGraphSceneReadyEventBlock",i),e.s(["FlowGraphSceneReadyEventBlock",0,i])},83446,e=>{"use strict";var t=e.i(263537);let r="bilateralBlurPixelShader",i=`uniform sampler2D textureSampler;uniform sampler2D depthSampler;uniform sampler2D normalSampler;uniform int filterSize;uniform vec2 blurDir;uniform float depthThreshold;uniform float normalThreshold;varying vec2 vUV;void main(void) {vec3 color=textureLod(textureSampler,vUV,0.).rgb;float depth=textureLod(depthSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(color,1.);return;}
vec3 normal=textureLod(normalSampler,vUV,0.).rgb;
#ifdef DECODE_NORMAL
normal=normal*2.0-1.0;
#endif
...
glFragColor=vec4(sum/wsum,1.);}
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["bilateralBlurPixelShader",0,{name:r,shader:i}])},206234,e=>{"use strict";var t=e.i(263537);let r="iblCdfyPixelShader",i=`varying vUV : vec2f;
#include <helperFunctions>
#ifdef IBL_USE_CUBE_MAP
var iblSourceSampler: sampler;var iblSource: texture_cube<f32>;
#else
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["pickingVertexShader",0,{name:r,shader:i}])},444e3,e=>{"use strict";var t=e.i(263537);let r="boundingBoxRendererUboDeclaration",i=`#ifdef WEBGL2
...
gl_FragColor=color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["boundingBoxRendererPixelShader",0,{name:a,shader:o}],277886)},605261,e=>{"use strict";var t=e.i(353679),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.body=this.registerDataInput("body",r.RichTypeAny),this.force=this.registerDataInput("force",r.RichTypeVector3),this.location=this.registerDataInput("location",r.RichTypeVector3)}_execute(e,t){let r=this.body.getValue(e);if(!r){this._reportError(e,"No physics body provided"),this.out._activateSignal(e);return}let i=this.force.getValue(e),a=this.location.getValue(e);r.applyForce(i,a),this.out._activateSignal(e)}getClassName(){return"FlowGraphApplyForceBlock"}}(0,i.RegisterClass)("FlowGraphApplyForceBlock",a),e.s(["FlowGraphApplyForceBlock",0,a])},221493,e=>{"use strict";var t=e.i(263537);e.i(407892),e.i(380244),e.i(585817),e.i(945868),e.i(349e3),e.i(13486),e.i(988389),e.i(431235),e.i(300889),e.i(398879),e.i(92372),e.i(84318);let r="depthVertexShader",i=`attribute position: vec3f;
#include<bonesDeclaration>
#include<bakedVertexAnimationDeclaration>
#include<morphTargetsVertexGlobalDeclaration>
#include<morphTargetsVertexDeclaration>[0..maxSimultaneousMorphTargets]
...
#endif
}`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["kernelBlurPixelShader",0,{name:n,shader:s}],389895)},757513,e=>{"use strict";var t=e.i(774685),r=e.i(303663);class i extends r.FlowGraphExecutionBlock{constructor(e){super(e),this.config=e,this.executionSignals=[],this.setNumberOfOutputSignals(this.config.outputSignalCount)}_execute(e){for(let t=0;t<this.executionSignals.length;t++)this.executionSignals[t]._activateSignal(e)}setNumberOfOutputSignals(e=1){for(;this.executionSignals.length>e;){let e=this.executionSignals.pop();e&&(e.disconnectFromAll(),this._unregisterSignalOutput(e.name))}for(;this.executionSignals.length<e;)this.executionSignals.push(this._registerSignalOutput(`out_${this.executionSignals.length}`))}getClassName(){return"FlowGraphSequenceBlock"}}(0,t.RegisterClass)("FlowGraphSequenceBlock",i),e.s(["FlowGraphSequenceBlock",0,i])},929154,e=>{"use strict";var t=e.i(916624),r=e.i(774685),i=e.i(353679),a=e.i(700183);class o extends i.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.config=e,this.condition=this.registerDataInput("condition",t.RichTypeBoolean),this.executionFlow=this._registerSignalOutput("executionFlow"),this.completed=this._registerSignalOutput("completed"),this._unregisterSignalOutput("out")}_execute(e,t){let r=this.condition.getValue(e);this.config?.doWhile&&!r&&this.executionFlow._activateSignal(e);let i=0;for(;r;){if(this.executionFlow._activateSignal(e),++i>=o.MaxLoopCount){a.Logger.Warn("FlowGraphWhileLoopBlock: Max loop count reached. Breaking.");break}r=this.condition.getValue(e)}this.completed._activateSignal(e)}getClassName(){return"FlowGraphWhileLoopBlock"}}o.MaxLoopCount=1e3,(0,r.RegisterClass)("FlowGraphWhileLoopBlock",o),e.s(["FlowGraphWhileLoopBlock",0,o])},629101,e=>{"use strict";var t=e.i(440163),r=e.i(916624),i=e.i(774685),a=e.i(774100);class o extends t.FlowGraphBlock{constructor(e){super(e),this.config=e,this.object=this.registerDataInput("object",r.RichTypeAny),this.array=this.registerDataInput("array",r.RichTypeAny),this.index=this.registerDataOutput("index",r.RichTypeFlowGraphInteger,new a.FlowGraphInteger(-1))}_updateOutputs(e){let t=this.object.getValue(e),r=this.array.getValue(e);r&&this.index.setValue(new a.FlowGraphInteger(r.indexOf(t)),e)}serialize(e){super.serialize(e)}getClassName(){return"FlowGraphIndexOfBlock"}}(0,i.RegisterClass)("FlowGraphIndexOfBlock",o),e.s(["FlowGraphIndexOfBlock",0,o])},475294,e=>{"use strict";var t=e.i(263537);let r="iblShadowGBufferDebugPixelShader",i=`#ifdef GL_ES
precision mediump float;
#endif
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingParticleThicknessPixelShader",0,{name:r,shader:i}])},341421,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingParticleThicknessPixelShader",i=`uniform particleAlpha: f32;varying uv: vec2f;@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var normalxy: vec2f=input.uv*2.0-1.0;var r2: f32=dot(normalxy,normalxy);if (r2>1.0) {discard;}
var thickness: f32=sqrt(1.0-r2);fragmentOutputs.color=vec4f(vec3f(uniforms.particleAlpha*thickness),1.0);}
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingParticleThicknessPixelShaderWGSL",0,{name:r,shader:i}])},502829,e=>{"use strict";var t=e.i(263537);let r="glowMapMergeVertexShader",i=`attribute position: vec2f;varying vUV: vec2f;
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["glowMapMergeVertexShaderWGSL",0,{name:r,shader:i}])},943194,e=>{"use strict";var t=e.i(263537);let r="proceduralVertexShader",i=`attribute position: vec2f;varying vPosition: vec2f;varying vUV: vec2f;const madd: vec2f= vec2f(0.5,0.5);
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
fn main(input : VertexInputs)->FragmentInputs {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["proceduralVertexShaderWGSL",0,{name:r,shader:i}])},125905,e=>{"use strict";var t=e.i(263537);let r="hdrIrradianceFilteringVertexShader",i=`attribute vec2 position;varying vec3 direction;uniform vec3 up;uniform vec3 right;uniform vec3 front;
#define CUSTOM_VERTEX_DEFINITIONS
void main(void) {
#define CUSTOM_VERTEX_MAIN_BEGIN
mat3 view=mat3(up,right,front);direction=view*vec3(position,1.0);gl_Position=vec4(position,0.0,1.0);
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["hdrIrradianceFilteringVertexShader",0,{name:r,shader:i}])},621517,e=>{"use strict";var t=e.i(263537);let r="ssaoCombinePixelShader",i=`uniform sampler2D textureSampler;uniform sampler2D originalColor;uniform vec4 viewport;varying vec2 vUV;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) {
#define CUSTOM_FRAGMENT_MAIN_BEGIN
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["ssaoCombinePixelShader",0,{name:r,shader:i}])},710773,e=>{"use strict";var t=e.i(263537);let r="iblCdfxPixelShader",i=`precision highp sampler2D;
#define PI 3.1415927
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["iblVoxelGridVertexShaderWGSL",0,{name:r,shader:i}])},608087,e=>{"use strict";var t=e.i(263537);e.i(828487),e.i(739589);let r="kernelBlurFragment",i=`#ifdef DOF
...
#endif
}`;t.ShaderStore.ShadersStoreWGSL[n]||(t.ShaderStore.ShadersStoreWGSL[n]=s),e.s(["kernelBlurPixelShaderWGSL",0,{name:n,shader:s}],608087)},782117,e=>{"use strict";var t=e.i(263537);e.i(624154),e.i(568039),e.i(298378),e.i(369136),e.i(182478),e.i(880779);let r="pointCloudVertexDeclaration",i=`#ifdef POINTSIZE
uniform float pointSize;
#endif
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["depthOfFieldMergePixelShaderWGSL",0,{name:r,shader:i}])},755610,e=>{"use strict";var t=e.i(263537);let r="glowMapMergePixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;
#ifdef EMISSIVE
...
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void)
{vec4 screen_color=texture2D(textureSampler,vUV);gl_FragColor=sampleAs3DTexture(colorTable,screen_color.rgb,SLICE_COUNT);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["colorCorrectionPixelShader",0,{name:r,shader:i}])}]);