...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([],317336);let t="openpbrGeometryInfo",a=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=a),e.s([],348290);let n="openpbrIblFunctions",s=`#ifdef REFLECTION
...
#endif
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=s),e.s([],250464)},15722,e=>{"use strict";var i=e.i(263537);let o="openpbrSubsurfaceLayerData",r=`float subsurface_weight=vSubsurfaceWeight;vec3 subsurface_color=vSubsurfaceColor.rgb;float subsurface_radius=vSubsurfaceRadius;vec3 subsurface_radius_scale=vSubsurfaceRadiusScale;float subsurface_scatter_anisotropy=clamp(vSubsurfaceScatterAnisotropy,-0.9999,0.9999);
...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.i(494429),e.i(656864),e.i(697427),e.i(10564),e.i(959117),e.i(533790);let t="openpbrFragmentSamplersDeclaration",a=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=a),e.i(315647),e.i(261937),e.i(127010),e.i(190688),e.i(201632),e.i(913724),e.i(442357),e.i(498659),e.i(310063),e.i(121541),e.i(241326),e.i(714090),e.i(608404),e.i(424192),e.i(289258),e.i(541499),e.i(80054);let n="openpbrNormalMapFragmentMainFunctions",s=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=s);let c="openpbrNormalMapFragmentFunctions",f=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;i.ShaderStore.IncludesShadersStore[c]||(i.ShaderStore.IncludesShadersStore[c]=f),e.i(534236),e.i(317336);let l="openpbrConductorReflectance",d=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;i.ShaderStore.IncludesShadersStore[l]||(i.ShaderStore.IncludesShadersStore[l]=d);let _="openpbrAmbientOcclusionFunctions",m=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;i.ShaderStore.IncludesShadersStore[_]||(i.ShaderStore.IncludesShadersStore[_]=m),e.i(348290),e.i(250464);let u="openpbrVolumeFunctions",v=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;i.ShaderStore.IncludesShadersStore[u]||(i.ShaderStore.IncludesShadersStore[u]=v),e.i(141687),e.i(264704);let g="openpbrNormalMapFragment",E=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;i.ShaderStore.IncludesShadersStore[g]||(i.ShaderStore.IncludesShadersStore[g]=E);let p="openpbrBlockNormalFinal",I=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[p]||(i.ShaderStore.IncludesShadersStore[p]=I);let S="openpbrBaseLayerData",R=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;i.ShaderStore.IncludesShadersStore[h]||(i.ShaderStore.IncludesShadersStore[h]=T);let A="openpbrThinFilmLayerData",N=`#ifdef THIN_FILM
...
#endif
`;i.ShaderStore.IncludesShadersStore[A]||(i.ShaderStore.IncludesShadersStore[A]=N);let b="openpbrFuzzLayerData",F=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[b]||(i.ShaderStore.IncludesShadersStore[b]=F);let L="openpbrAmbientOcclusionData",C=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;i.ShaderStore.IncludesShadersStore[L]||(i.ShaderStore.IncludesShadersStore[L]=C),e.i(449399);let O="openpbrBackgroundTransmission",D=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;i.ShaderStore.IncludesShadersStore[O]||(i.ShaderStore.IncludesShadersStore[O]=D);let M="openpbrEnvironmentLighting",P=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;i.ShaderStore.IncludesShadersStore[M]||(i.ShaderStore.IncludesShadersStore[M]=P);let x="openpbrDirectLightingInit",G=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[x]||(i.ShaderStore.IncludesShadersStore[x]=G);let y="openpbrDirectLighting",z=`#ifdef LIGHT{X}
...
#endif
`;i.ShaderStore.IncludesShadersStore[y]||(i.ShaderStore.IncludesShadersStore[y]=z),e.i(358759),e.i(313119),e.i(65018);let U="openpbrBlockPrePass",W=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[U]||(i.ShaderStore.IncludesShadersStore[U]=W),e.i(776892),e.i(510465);let w="openpbrPixelShader",B=`#define OPENPBR_FRAGMENT_SHADER
...
`;i.ShaderStore.ShadersStore[w]||(i.ShaderStore.ShadersStore[w]=B),e.s(["openpbrPixelShader",0,{name:w,shader:B}],10621)}]);