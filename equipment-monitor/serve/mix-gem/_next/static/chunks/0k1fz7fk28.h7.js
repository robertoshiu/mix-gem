...
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=a),e.i(835189),e.i(656864),e.i(697427),e.i(10564),e.i(959117);let r="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=f),e.i(533790);let o="pbrFragmentSamplersDeclaration",t=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.i(315647),e.i(261937),e.i(127010),e.i(190688),e.i(201632),e.i(913724),e.i(442357),e.i(498659),e.i(310063),e.i(121541),e.i(241326),e.i(714090),e.i(608404),e.i(424192),e.i(289258),e.i(541499),e.i(80054),e.i(120238),e.i(376170),e.i(534236),e.i(95199);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
...
`;i.ShaderStore.IncludesShadersStore[E]||(i.ShaderStore.IncludesShadersStore[E]=R);let S="pbrBlockAlphaFresnel",C=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[S]||(i.ShaderStore.IncludesShadersStore[S]=C);let u="pbrBlockAnisotropic",A=`#ifdef ANISOTROPIC
...
#endif
`;i.ShaderStore.IncludesShadersStore[u]||(i.ShaderStore.IncludesShadersStore[u]=A);let I="pbrBlockReflection",m=`#ifdef REFLECTION
...
#endif
`;i.ShaderStore.IncludesShadersStore[I]||(i.ShaderStore.IncludesShadersStore[I]=m);let v="pbrBlockSheen",N=`#ifdef SHEEN
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[T]||(i.ShaderStore.IncludesShadersStore[T]=O);let L="pbrBlockIridescence",p=`struct iridescenceOutParams
...
#endif
`;i.ShaderStore.IncludesShadersStore[L]||(i.ShaderStore.IncludesShadersStore[L]=p);let _="pbrBlockSubSurface",M=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[_]||(i.ShaderStore.IncludesShadersStore[_]=M),e.i(367959);let D="pbrBlockReflectance0",h=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;i.ShaderStore.IncludesShadersStore[D]||(i.ShaderStore.IncludesShadersStore[D]=h);let F="pbrClusteredLightingFunctions",g=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;i.ShaderStore.IncludesShadersStore[F]||(i.ShaderStore.IncludesShadersStore[F]=g),e.i(141687),e.i(264704),e.i(48973);let P="pbrBlockNormalFinal",U=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[P]||(i.ShaderStore.IncludesShadersStore[P]=U),e.i(449399);let b="pbrBlockLightmapInit",y=`#ifdef LIGHTMAP
...
#endif
`;i.ShaderStore.IncludesShadersStore[x]||(i.ShaderStore.IncludesShadersStore[x]=W),e.i(274561);let Y="pbrBlockFinalLitComponents",X=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[Y]||(i.ShaderStore.IncludesShadersStore[Y]=X);let k="pbrBlockFinalUnlitComponents",w=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;i.ShaderStore.IncludesShadersStore[k]||(i.ShaderStore.IncludesShadersStore[k]=w);let K="pbrBlockFinalColorComposition",z=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.ShaderStore.IncludesShadersStore[K]||(i.ShaderStore.IncludesShadersStore[K]=z),e.i(358759),e.i(313119),e.i(65018);let Z="pbrBlockPrePass",q=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[Z]||(i.ShaderStore.IncludesShadersStore[Z]=q),e.i(776892),e.i(510465);let J="pbrPixelShader",j=`#define PBR_FRAGMENT_SHADER
...
`;i.ShaderStore.ShadersStore[J]||(i.ShaderStore.ShadersStore[J]=j),e.s(["pbrPixelShader",0,{name:J,shader:j}],279663)}]);