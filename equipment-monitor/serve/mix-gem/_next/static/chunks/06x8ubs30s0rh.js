...
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["clipPlaneVertexDeclaration",0,{name:r,shader:i}])},127010,e=>{"use strict";var t=e.i(263537);let r="logDepthDeclaration",i=`#ifdef LOGARITHMICDEPTH
...
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},957479,e=>{"use strict";var t=e.i(263537);let r="lightVxFragmentDeclaration",i=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["lightVxUboDeclaration",0,{name:r,shader:i}])},294715,e=>{"use strict";var t=e.i(263537);let r="shadowsVertex",i=`#ifdef SHADOWS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["morphTargetsVertexGlobalWGSL",0,{name:r,shader:i}])},945868,e=>{"use strict";var t=e.i(263537);let r="morphTargetsVertexDeclaration",i=`#ifdef MORPHTARGETS
#ifndef MORPHTARGETS_TEXTURE
#ifdef MORPHTARGETS_POSITION
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["morphTargetsVertexDeclarationWGSL",0,{name:r,shader:i}])},585817,e=>{"use strict";var t=e.i(263537);let r="morphTargetsVertexGlobalDeclaration",i=`#ifdef MORPHTARGETS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s(["morphTargetsVertexGlobalDeclarationWGSL",0,{name:r,shader:i}])},874826,e=>{"use strict";var t=e.i(263537);let r="bumpVertex",i=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([],314530);let a="prePassVertexDeclaration",o=`#ifdef PREPASS
#ifdef PREPASS_LOCAL_POSITION
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[a]||(t.ShaderStore.IncludesShadersStoreWGSL[a]=o),e.s([],794415);let n="samplerVertexDeclaration",s=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=s),e.s([],597792);let l="vertexPullingVertex",f=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[l]||(t.ShaderStore.IncludesShadersStoreWGSL[l]=f),e.s([],229624);let c="prePassVertex",d=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[c]||(t.ShaderStore.IncludesShadersStoreWGSL[c]=d),e.s([],355157);let u="uvVariableDeclaration",p=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[u]||(t.ShaderStore.IncludesShadersStoreWGSL[u]=p),e.s([],838597);let m="samplerVertexImplementation",v=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["defaultPixelShader",0,{name:r,shader:i}])},932361,e=>{"use strict";var t=e.i(263537);e.i(629238);let r="backgroundUboDeclaration",i=`layout(std140,column_major) uniform;uniform Material
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["defaultPixelShaderWGSL",0,{name:r,shader:i}])},529413,e=>{"use strict";var t=e.i(263537);e.i(24012),e.i(861230);let r="openpbrVertexDeclaration",i=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["geometryPixelShader",0,{name:r,shader:i}])},78291,e=>{"use strict";var t=e.i(263537);let r="rsmFullGlobalIlluminationPixelShader",i=`/**
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lightProxyVertexShader",0,{name:r,shader:i}])},847693,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(127010),e.i(190688),e.i(358759),e.i(313119);let r="gaussianSplattingFragmentDeclaration",i=`vec4 gaussianColor(vec4 inColor)
...
`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["gaussianSplattingPixelShader",0,{name:a,shader:o}],847693)},735089,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(315647),e.i(127010),e.i(201632),e.i(310063),e.i(190688),e.i(141687),e.i(358759),e.i(313119);let r="particlesPixelShader",i=`#ifdef LOGARITHMICDEPTH
#extension GL_EXT_frag_depth : enable
#endif
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingBilateralBlurPixelShader",0,{name:r,shader:i}])},813299,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="extractHighlightsPixelShader",i=`#include<helperFunctions>
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["glowMapMergePixelShaderWGSL",0,{name:r,shader:i}])},565594,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(127010),e.i(141687),e.i(358759);let r="outlinePixelShader",i=`#ifdef LOGARITHMICDEPTH
#extension GL_EXT_frag_depth : enable
#endif
uniform vec4 color;
#ifdef ALPHATEST
...
gl_FragColor=color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["outlinePixelShader",0,{name:r,shader:i}])},259652,e=>{"use strict";var t=e.i(263537);e.i(755704),e.i(562396),e.i(212954),e.i(922446);let r="colorPixelShader",i=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
#define VERTEXCOLOR
varying vColor: vec4f;
#else
uniform color: vec4f;
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["colorPixelShaderWGSL",0,{name:r,shader:i}])},24163,e=>{"use strict";var t=e.i(263537);e.i(201632),e.i(442357),e.i(424192),e.i(289258);let r="hdrIrradianceFilteringPixelShader",i=`#include<helperFunctions>
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["bloomMergePixelShaderWGSL",0,{name:r,shader:i}])},180477,e=>{"use strict";var t=e.i(263537);let r="passCubePixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_cube<f32>;
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[i]||(t.ShaderStore.ShadersStore[i]=a),e.s(["kernelBlurVertexShader",0,{name:i,shader:a}],308552)},923802,e=>{"use strict";var t=e.i(263537);let r="convolutionPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform float kernel[9];
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void)
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["circleOfConfusionPixelShaderWGSL",0,{name:r,shader:i}])},593093,e=>{"use strict";var t=e.i(263537);let r="iblGenerateVoxelMipPixelShader",i=`varying vUV: vec2f;var srcMip: texture_3d<f32>;uniform layerNum: i32;@fragment
...
gl_FragColor=baseColor;}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["glowBlurPostProcessPixelShader",0,{name:r,shader:i}])},850215,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="grainPixelShader",i=`#include<helperFunctions>
...
fragmentOutputs.color= vec4f((colorSum/kernelWeight).rgb,1);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["convolutionPixelShaderWGSL",0,{name:r,shader:i}])},209230,e=>{"use strict";var t=e.i(263537);let r="backgroundVertexDeclaration",i=`uniform mat4 view;uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
...
`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["backgroundVertexShader",0,{name:a,shader:o}],209230)},710936,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingRenderPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
#define IOR 1.333
#define ETA 1.0/IOR
#define F0 0.02
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingRenderPixelShader",0,{name:r,shader:i}])},66878,e=>{"use strict";var t=e.i(263537);e.i(186207);let r="iblVoxelGridPixelShader",i=`#extension GL_EXT_draw_buffers : require
...
gl_FragColor=baseColor;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["glowMapMergePixelShader",0,{name:r,shader:i}])},316109,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="iblScaledLuminancePixelShader",i=`#include<helperFunctions>
#ifdef IBL_USE_CUBE_MAP
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["lineVertexShaderWGSL",0,{name:r,shader:i}])},584622,e=>{"use strict";var t=e.i(263537);e.i(562396),e.i(357351),e.i(476129),e.i(922446);let r="imageProcessingCompatibility",i=`#ifdef IMAGEPROCESSINGPOSTPROCESS
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingParticleDepthPixelShaderWGSL",0,{name:r,shader:i}])},429196,e=>{"use strict";var t=e.i(263537);let r="oitBackBlendPixelShader",i=`var uBackColor: texture_2d<f32>;@fragment
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["oitBackBlendPixelShaderWGSL",0,{name:r,shader:i}])},668740,e=>{"use strict";var t=e.i(263537);let r="displayPassPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform sampler2D passSampler;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void)
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lensFlareVertexShader",0,{name:r,shader:i}])},322356,e=>{"use strict";var t=e.i(263537);let r="shadowMapFragmentSoftTransparentShadow",i=`#if SM_SOFTTRANSPARENTSHADOW==1
if ((bayerDither8(floor(mod(gl_FragCoord.xy,8.0))))/64.0>=softTransparentShadowSM.x*alpha) discard;
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s(["shadowMapFragmentSoftTransparentShadow",0,{name:r,shader:i}])},551150,e=>{"use strict";var t=e.i(263537);e.i(315647),e.i(201632),e.i(310063);let r="imageProcessingPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;
#include<imageProcessingDeclaration>
#include<helperFunctions>
#include<imageProcessingFunctions>
#define CUSTOM_FRAGMENT_DEFINITIONS
...
#endif
#endif
gl_FragColor=result;}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["imageProcessingPixelShader",0,{name:r,shader:i}])},678153,e=>{"use strict";var t=e.i(263537);let r="taaPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform sampler2D historySampler;
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["taaPixelShader",0,{name:r,shader:i}])},700731,e=>{"use strict";var t=e.i(263537);let r="passPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) 
...
discard;}}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["oitBackBlendPixelShader",0,{name:r,shader:i}])},463195,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererMaskerPixelShader",i=`varying vUV: vec2f;@fragment
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["outlineVertexShaderWGSL",0,{name:r,shader:i}])},502332,e=>{"use strict";var t=e.i(263537);let r="minmaxReduxPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;
#if defined(INITIAL)
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingParticleDepthVertexShader",0,{name:r,shader:i}])},49256,e=>{"use strict";var t=e.i(263537);e.i(201632),e.i(261937),e.i(141687);let r="glowMapGenerationPixelShader",i=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
#include<helperFunctions>
#endif
#ifdef DIFFUSE
...
#endif
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["glowMapGenerationPixelShader",0,{name:r,shader:i}])},270161,e=>{"use strict";var t=e.i(263537);let r="iblShadowSpatialBlurPixelShader",i=`#define PI 3.1415927
...
#include<vertexColorMixing>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["colorVertexShader",0,{name:r,shader:i}])},495562,e=>{"use strict";var t=e.i(263537);let r="motionBlurPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float motionStrength;uniform float motionScale;uniform vec2 screenSize;
#ifdef OBJECT_BASED
uniform sampler2D velocitySampler;
#else
...
fragmentOutputs.color=uniforms.color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["linePixelShaderWGSL",0,{name:r,shader:i}])},187030,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(190688),e.i(141687),e.i(313119);let r="colorPixelShader",i=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
#define VERTEXCOLOR
varying vec4 vColor;
#else
uniform vec4 color;
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingParticleDepthPixelShader",0,{name:r,shader:i}])},848458,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="copyTextureToTexturePixelShader",i=`uniform conversion: f32;
#ifndef NO_SAMPLER
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["copyTextureToTexturePixelShaderWGSL",0,{name:r,shader:i}])},778896,e=>{"use strict";var t=e.i(263537);let r="pickingPixelShader",i=`#if defined(INSTANCES)
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["pickingPixelShader",0,{name:r,shader:i}])},574392,e=>{"use strict";var t=e.i(263537);e.i(880779),e.i(587630);let r="greasedLineVertexShader",i=`precision highp float;
#include<instancesDeclaration>
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblIcdfPixelShader",0,{name:r,shader:i}])},907099,e=>{"use strict";var t=e.i(263537);e.i(261937),e.i(346145),e.i(141687);let r="depthPixelShader",i=`#ifdef ALPHATEST
varying vec2 vUV;uniform sampler2D diffuseSampler;
#endif
#include<clipPlaneFragmentDeclaration>
...
#endif
#endif
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["depthPixelShader",0,{name:r,shader:i}])},964508,e=>{"use strict";var t=e.i(263537);e.i(738124),e.i(120091),e.i(590030),e.i(481519);let r="hdrFilteringPixelShader",i=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
...
gl_FragColor=color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["linePixelShader",0,{name:r,shader:i}])},7383,e=>{"use strict";var t=e.i(263537);let r="boundingBoxRendererVertexShader",i=`attribute position: vec3f;uniform world: mat4x4f;uniform viewProjection: mat4x4f;
#ifdef INSTANCES
attribute world0 : vec4<f32>;attribute world1 : vec4<f32>;attribute world2 : vec4<f32>;attribute world3 : vec4<f32>;
#endif
#define CUSTOM_VERTEX_DEFINITIONS
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["screenSpaceReflection2BlurPixelShader",0,{name:r,shader:i}])},873146,e=>{"use strict";var t=e.i(263537);let r="backgroundFragmentDeclaration",i=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
#ifdef USEHIGHLIGHTANDSHADOWCOLORS
...
`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["backgroundPixelShader",0,{name:n,shader:s}],873146)},436916,e=>{"use strict";var t=e.i(263537);e.i(929870),e.i(314530),e.i(738124),e.i(407892),e.i(380244),e.i(13486),e.i(794415),e.i(865557),e.i(597792),e.i(553893),e.i(349e3),e.i(158271);let r="lightVxFragmentDeclaration",i=`#ifdef LIGHT{X}
...
`;t.ShaderStore.ShadersStoreWGSL[a]||(t.ShaderStore.ShadersStoreWGSL[a]=o),e.s(["defaultVertexShaderWGSL",0,{name:a,shader:o}],436916)},62766,e=>{"use strict";var t=e.i(263537);let r="screenSpaceRayTrace",i=`float distanceSquared(vec2 a,vec2 b) { a-=b; return dot(a,a); }
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["particlesVertexShader",0,{name:r,shader:i}])},752114,e=>{"use strict";var t=e.i(263537);e.i(738124),e.i(755704),e.i(212954);let r="glowMapGenerationPixelShader",i=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
#include<helperFunctions>
#endif
#ifdef DIFFUSE
...
lightDir/=float(NUM_SAMPLES);gl_FragColor=vec4(lightDir,1.0);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblDominantDirectionPixelShader",0,{name:r,shader:i}])},266104,e=>{"use strict";var t=e.i(263537);let r="circleOfConfusionPixelShader",i=`uniform sampler2D depthSampler;varying vec2 vUV;
#ifndef COC_DEPTH_NOT_NORMALIZED
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lodCubePixelShader",0,{name:r,shader:i}])},582914,e=>{"use strict";var t=e.i(263537);e.i(243400),e.i(561525);let r="lightProxyVertexShader",i=`attribute position: vec3f;flat varying vOffset: u32;flat varying vMask: u32;
#include<sceneUboDeclaration>
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["lightProxyVertexShaderWGSL",0,{name:r,shader:i}])},614157,e=>{"use strict";var t=e.i(263537);let r="iblCdfDebugPixelShader",i=`precision highp samplerCube;
#define PI 3.1415927
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblCdfDebugPixelShader",0,{name:r,shader:i}])},925823,e=>{"use strict";var t=e.i(263537);let r="shadowMapFragment",i=`float depthSM=vDepthMetricSM;
...
}`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["shadowMapPixelShader",0,{name:n,shader:s}],611061)},637012,e=>{"use strict";var t=e.i(263537);let r="fxaaPixelShader",i=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
gl_FragColor=TEXTUREFUNC(textureSampler,posM,0.0);
#endif
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fxaaPixelShader",0,{name:r,shader:i}])},252675,e=>{"use strict";var t=e.i(263537);e.i(738124),e.i(590030),e.i(12799);let r="screenSpaceReflection2PixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["screenSpaceReflection2PixelShaderWGSL",0,{name:r,shader:i}])},606294,e=>{"use strict";var t=e.i(263537);e.i(861230);let r="defaultVertexDeclaration",i=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
uniform mat4 view;
...
`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["defaultVertexShader",0,{name:a,shader:o}],606294)},165320,e=>{"use strict";var t=e.i(263537);e.i(201632);let r="iblShadowVoxelTracingPixelShader",i=`precision highp sampler2D;precision highp sampler3D;
#include<helperFunctions>
varying vec2 vUV;
#define DISABLE_UNIFORMITY_ANALYSIS
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingStandardBlurPixelShader",0,{name:r,shader:i}])},572875,e=>{"use strict";var t=e.i(263537);e.i(738124),e.i(120091),e.i(590030),e.i(481519);let r="iblDominantDirectionPixelShader",i=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
...
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["layerPixelShaderWGSL",0,{name:r,shader:i}])},104396,e=>{"use strict";var t=e.i(263537);let r="rsmGlobalIlluminationPixelShader",i=`/**
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["rsmGlobalIlluminationPixelShader",0,{name:r,shader:i}])},475086,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererFinaliserPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["meshUVSpaceRendererFinaliserPixelShaderWGSL",0,{name:r,shader:i}])},225893,e=>{"use strict";var t=e.i(263537);let r="taaPixelShader",i=`varying vUV: vec2f;var textureSampler: texture_2d<f32>;var historySampler: texture_2d<f32>;
#ifdef TAA_REPROJECT_HISTORY
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["taaPixelShaderWGSL",0,{name:r,shader:i}])},102174,e=>{"use strict";var t=e.i(263537);let r="vrDistortionCorrectionPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["vrDistortionCorrectionPixelShaderWGSL",0,{name:r,shader:i}])},340389,e=>{"use strict";var t=e.i(263537);e.i(201632);let r="rgbdDecodePixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;
#include<helperFunctions>
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) 
{gl_FragColor=vec4(fromRGBD(texture2D(textureSampler,vUV)),1.0);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["rgbdDecodePixelShader",0,{name:r,shader:i}])},73730,e=>{"use strict";var t=e.i(263537);let r="proceduralVertexShader",i=`attribute vec2 position;varying vec2 vPosition;varying vec2 vUV;const vec2 madd=vec2(0.5,0.5);
#define CUSTOM_VERTEX_DEFINITIONS
void main(void) {
#define CUSTOM_VERTEX_MAIN_BEGIN
vPosition=position;vUV=position*madd+madd;gl_Position=vec4(position,0.0,1.0);
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["proceduralVertexShader",0,{name:r,shader:i}])},2064,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererFinaliserVertexShader",i=`precision highp float;attribute vec3 position;attribute vec2 uv;uniform mat4 worldViewProjection;varying vec2 vUV;void main() {gl_Position=worldViewProjection*vec4(position,1.0);vUV=uv;}
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["meshUVSpaceRendererFinaliserVertexShader",0,{name:r,shader:i}])},354754,e=>{"use strict";var t=e.i(263537);let r="lensFlarePixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec4 color;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) {
#define CUSTOM_FRAGMENT_MAIN_BEGIN
vec4 baseColor=texture2D(textureSampler,vUV);gl_FragColor=baseColor*color;
#define CUSTOM_FRAGMENT_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lensFlarePixelShader",0,{name:r,shader:i}])},295803,e=>{"use strict";var t=e.i(263537);let r="minmaxReduxPixelShader",i=`varying vUV: vec2f;var textureSampler: texture_2d<f32>;
#if defined(INITIAL)
...
discard;}}
#endif
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["minmaxReduxPixelShaderWGSL",0,{name:r,shader:i}])},564919,e=>{"use strict";var t=e.i(263537);let r="iblShadowAccumulationPixelShader",i=`varying vUV: vec2f;uniform accumulationParameters: vec4f;
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["geometryVertexShaderWGSL",0,{name:r,shader:i}])},319240,197003,549030,e=>{"use strict";var t=e.i(263537);let r="gaussianSplattingVertexDeclaration";t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;"),e.s([],319240),e.i(629238),e.i(997900);let i="gaussianSplattingUboDeclaration",a=`#include<sceneUboDeclaration>
#include<meshUboDeclaration>
...
#endif
#endif
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["ssao2PixelShaderWGSL",0,{name:r,shader:i}])},12799,e=>{"use strict";var t=e.i(263537);let r="screenSpaceRayTrace",i=`fn distanceSquared(a: vec2f,b: vec2f)->f32 { 
var temp=a-b; 
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["screenSpaceReflection2BlurCombinerPixelShaderWGSL",0,{name:r,shader:i}])},976458,e=>{"use strict";var t=e.i(263537);let r="meshUVSpaceRendererMaskerVertexShader",i=`attribute uv: vec2f;varying vUV: vec2f;@vertex
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lightProxyPixelShader",0,{name:r,shader:i}])},348199,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingRenderPixelShader",i=`#define DISABLE_UNIFORMITY_ANALYSIS
#define IOR 1.333
#define ETA 1.0/IOR
#define F0 0.02
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["screenSpaceReflection2PixelShader",0,{name:r,shader:i}])},472772,e=>{"use strict";var t=e.i(263537);e.i(585817),e.i(945868),e.i(465697),e.i(398879),e.i(92372);let r="iblVoxelGridVertexShader",i=`#include <bakedVertexAnimationDeclaration>
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingBilateralBlurPixelShaderWGSL",0,{name:r,shader:i}])},929154,e=>{"use strict";var t=e.i(916624),r=e.i(774685),i=e.i(353679),a=e.i(700183);class o extends i.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.config=e,this.condition=this.registerDataInput("condition",t.RichTypeBoolean),this.executionFlow=this._registerSignalOutput("executionFlow"),this.completed=this._registerSignalOutput("completed"),this._unregisterSignalOutput("out")}_execute(e,t){let r=this.condition.getValue(e);this.config?.doWhile&&!r&&this.executionFlow._activateSignal(e);let i=0;for(;r;){if(this.executionFlow._activateSignal(e),++i>=o.MaxLoopCount){a.Logger.Warn("FlowGraphWhileLoopBlock: Max loop count reached. Breaking.");break}r=this.condition.getValue(e)}this.completed._activateSignal(e)}getClassName(){return"FlowGraphWhileLoopBlock"}}o.MaxLoopCount=1e3,(0,r.RegisterClass)("FlowGraphWhileLoopBlock",o),e.s(["FlowGraphWhileLoopBlock",0,o])},105308,e=>{"use strict";var t=e.i(263537);let r="lodCubePixelShader",i=`const GammaEncodePowerApprox=1.0/2.2;varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_cube<f32>;uniform lod: f32;uniform gamma: i32;@fragment
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["layerVertexShader",0,{name:r,shader:i}])},125905,e=>{"use strict";var t=e.i(263537);let r="hdrIrradianceFilteringVertexShader",i=`attribute vec2 position;varying vec3 direction;uniform vec3 up;uniform vec3 right;uniform vec3 front;
#define CUSTOM_VERTEX_DEFINITIONS
void main(void) {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["copyTexture3DLayerToTexturePixelShader",0,{name:r,shader:i}])},745078,e=>{"use strict";var t=e.i(263537);let r="lensFlareVertexShader",i=`attribute position: vec2f;uniform viewportMatrix: mat4x4f;varying vUV: vec2f;const madd: vec2f= vec2f(0.5,0.5);
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
fn main(input : VertexInputs)->FragmentInputs {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["lensFlareVertexShaderWGSL",0,{name:r,shader:i}])},502829,e=>{"use strict";var t=e.i(263537);let r="glowMapMergeVertexShader",i=`attribute position: vec2f;varying vUV: vec2f;
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["glowMapMergeVertexShaderWGSL",0,{name:r,shader:i}])},43308,e=>{"use strict";var t=e.i(263537);let r="copyTexture3DLayerToTexturePixelShader",i=`var textureSampler: texture_3d<f32>;uniform layerNum: i32;varying vUV: vec2f;@fragment
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["lineVertexShader",0,{name:n,shader:s}],837438)},671922,e=>{"use strict";var t=e.i(263537);e.i(13486),e.i(243400),e.i(706568),e.i(300889);let r="greasedLineVertexShader",i=`#include<instancesDeclaration>
#include<sceneUboDeclaration>
#include<meshUboDeclaration>
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["greasedLineVertexShaderWGSL",0,{name:r,shader:i}])},355369,e=>{"use strict";var t=e.i(263537);let r="depthOfFieldMergePixelShader",i=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
#define TEXTUREFUNC(s,c,lod) texture2DLodEXT(s,c,lod)
#else
#define TEXTUREFUNC(s,c,bias) texture2D(s,c,bias)
#endif
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["depthOfFieldMergePixelShader",0,{name:r,shader:i}])},103446,e=>{"use strict";var t=e.i(263537);let r="iblShadowSpatialBlurPixelShader",i=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["iblShadowSpatialBlurPixelShader",0,{name:r,shader:i}])},529653,e=>{"use strict";var t=e.i(263537);let r="iblCdfxPixelShader",i=`#define PI 3.1415927
...
fragmentOutputs.color= vec4f( vec3f(cdfx),1.0);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["iblCdfxPixelShaderWGSL",0,{name:r,shader:i}])},909939,e=>{"use strict";var t=e.i(263537);e.i(201632);let r="extractHighlightsPixelShader",i=`#include<helperFunctions>
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["ssaoCombinePixelShader",0,{name:r,shader:i}])},917516,e=>{"use strict";var t=e.i(263537);let r="blackAndWhitePixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float degree;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) 
{vec3 color=texture2D(textureSampler,vUV).rgb;float luminance=dot(color,vec3(0.3,0.59,0.11)); 
vec3 blackAndWhite=vec3(luminance,luminance,luminance);gl_FragColor=vec4(color-((color-blackAndWhite)*degree),1.0);}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["blackAndWhitePixelShader",0,{name:r,shader:i}])},138464,e=>{"use strict";var t=e.i(440163),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphBlock{constructor(e){super(e),this.condition=this.registerDataInput("condition",r.RichTypeBoolean),this.onTrue=this.registerDataInput("onTrue",r.RichTypeAny),this.onFalse=this.registerDataInput("onFalse",r.RichTypeAny),this.output=this.registerDataOutput("output",r.RichTypeAny)}_updateOutputs(e){let t=this.condition.getValue(e);this.output.setValue(t?this.onTrue.getValue(e):this.onFalse.getValue(e),e)}getClassName(){return"FlowGraphConditionalBlock"}}(0,i.RegisterClass)("FlowGraphConditionalBlock",a),e.s(["FlowGraphConditionalDataBlock",0,a])},147311,e=>{"use strict";var t=e.i(263537);e.i(30653),e.i(127010),e.i(94556);let r="spritesVertexShader",i=`attribute vec4 position;attribute vec2 options;attribute vec2 offsets;attribute vec2 inverts;attribute vec4 cellInfo;attribute vec4 color;uniform mat4 view;uniform mat4 projection;varying vec2 vUV;varying vec4 vColor;
#include<fogVertexDeclaration>
#include<logDepthDeclaration>
#define CUSTOM_VERTEX_DEFINITIONS
void main(void) {
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["spritesVertexShader",0,{name:r,shader:i}])},943194,e=>{"use strict";var t=e.i(263537);let r="proceduralVertexShader",i=`attribute position: vec2f;varying vPosition: vec2f;varying vUV: vec2f;const madd: vec2f= vec2f(0.5,0.5);
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
fn main(input : VertexInputs)->FragmentInputs {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["lightProxyPixelShaderWGSL",0,{name:r,shader:i}])},859826,e=>{"use strict";var t=e.i(263537);let r="bloomMergePixelShader",i=`uniform sampler2D textureSampler;uniform sampler2D bloomBlur;varying vec2 vUV;uniform float bloomWeight;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void)
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["layerVertexShaderWGSL",0,{name:r,shader:i}])},341421,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingParticleThicknessPixelShader",i=`uniform particleAlpha: f32;varying uv: vec2f;@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var normalxy: vec2f=input.uv*2.0-1.0;var r2: f32=dot(normalxy,normalxy);if (r2>1.0) {discard;}
var thickness: f32=sqrt(1.0-r2);fragmentOutputs.color=vec4f(vec3f(uniforms.particleAlpha*thickness),1.0);}
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fluidRenderingParticleThicknessPixelShaderWGSL",0,{name:r,shader:i}])},687977,e=>{"use strict";var t=e.i(263537);let r="iblCdfDebugPixelShader",i=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["iblCdfDebugPixelShaderWGSL",0,{name:r,shader:i}])},665221,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="iblIcdfPixelShader",i=`#include<helperFunctions>
varying vUV: vec2f;
#ifdef IBL_USE_CUBE_MAP
var iblSourceSampler: sampler;var iblSource: texture_cube<f32>;
#else
...
#endif
}`;t.ShaderStore.ShadersStoreWGSL[n]||(t.ShaderStore.ShadersStoreWGSL[n]=s),e.s(["kernelBlurPixelShaderWGSL",0,{name:n,shader:s}],608087)},389895,e=>{"use strict";var t=e.i(263537);e.i(704290),e.i(346145);let r="kernelBlurFragment",i=`#ifdef DOF
...
#endif
}`;t.ShaderStore.ShadersStore[n]||(t.ShaderStore.ShadersStore[n]=s),e.s(["kernelBlurPixelShader",0,{name:n,shader:s}],389895)},668568,e=>{"use strict";var t=e.i(263537);e.i(755704),e.i(739589),e.i(212954);let r="depthPixelShader",i=`#ifdef ALPHATEST
varying vUV: vec2f;var diffuseSamplerSampler: sampler;var diffuseSampler: texture_2d<f32>;
#endif
#include<clipPlaneFragmentDeclaration>
...
#endif
#endif
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["depthPixelShaderWGSL",0,{name:r,shader:i}])},226859,e=>{"use strict";var t=e.i(263537);let r="chromaticAberrationPixelShader",i=`uniform sampler2D textureSampler; 
...
#endif
fragmentOutputs.color= vec4f(colour.rgb,1.0);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["tonemapPixelShaderWGSL",0,{name:r,shader:i}])},759366,e=>{"use strict";var t=e.i(263537);let r="iblShadowAccumulationPixelShader",i=`#ifdef GL_ES
precision mediump float;
#endif
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["fxaaVertexShaderWGSL",0,{name:r,shader:i}])},766408,e=>{"use strict";var t=e.i(263537);let r="hdrIrradianceFilteringVertexShader",i=`attribute position: vec2f;varying direction: vec3f;uniform up: vec3f;uniform right: vec3f;uniform front: vec3f;
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
fn main(input : VertexInputs)->FragmentInputs {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[i]||(t.ShaderStore.ShadersStoreWGSL[i]=a),e.s(["kernelBlurVertexShaderWGSL",0,{name:i,shader:a}],785967)},630952,e=>{"use strict";var t=e.i(263537);e.i(738124);let r="rgbdEncodePixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;
#include<helperFunctions>
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {fragmentOutputs.color=toRGBD(textureSample(textureSampler,textureSamplerSampler,input.vUV).rgb);}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["rgbdEncodePixelShaderWGSL",0,{name:r,shader:i}])},649818,e=>{"use strict";var t=e.i(263537);let r="hdrFilteringVertexShader",i=`attribute position: vec2f;varying direction: vec3f;uniform up: vec3f;uniform right: vec3f;uniform front: vec3f;
#define CUSTOM_VERTEX_DEFINITIONS
@vertex
fn main(input : VertexInputs)->FragmentInputs {
#define CUSTOM_VERTEX_MAIN_BEGIN
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["gaussianSplattingVertexShader",0,{name:r,shader:i}])},221493,e=>{"use strict";var t=e.i(263537);e.i(407892),e.i(380244),e.i(585817),e.i(945868),e.i(349e3),e.i(13486),e.i(988389),e.i(431235),e.i(300889),e.i(398879),e.i(92372),e.i(84318);let r="depthVertexShader",i=`attribute position: vec3f;
#include<bonesDeclaration>
#include<bakedVertexAnimationDeclaration>
#include<morphTargetsVertexGlobalDeclaration>
#include<morphTargetsVertexDeclaration>[0..maxSimultaneousMorphTargets]
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["depthVertexShaderWGSL",0,{name:r,shader:i}])},759360,e=>{"use strict";var t=e.i(263537);let r="filterPixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform kernelMatrix: mat4x4f;
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["areaLightTextureProcessingPixelShader",0,{name:r,shader:i}])},304764,e=>{"use strict";var t=e.i(263537);let r="highlightsPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;const vec3 RGBLuminanceCoefficients=vec3(0.2126,0.7152,0.0722);
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void) 
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["lodPixelShader",0,{name:r,shader:i}])},206234,e=>{"use strict";var t=e.i(263537);let r="iblCdfyPixelShader",i=`varying vUV : vec2f;
#include <helperFunctions>
#ifdef IBL_USE_CUBE_MAP
var iblSourceSampler: sampler;var iblSource: texture_cube<f32>;
#else
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["particlesVertexShaderWGSL",0,{name:r,shader:i}])},917304,e=>{"use strict";var t=e.i(263537);e.i(624154),e.i(568039),e.i(298378),e.i(369136),e.i(201632),e.i(24012),e.i(773111);let r="shadowMapVertexDeclaration",i=`#include<sceneVertexDeclaration>
...
#endif
#include<clipPlaneVertex>
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["glowMapGenerationVertexShaderWGSL",0,{name:r,shader:i}])},769900,e=>{"use strict";var t=e.i(263537);let r="hdrFilteringVertexShader",i=`attribute vec2 position;varying vec3 direction;uniform vec3 up;uniform vec3 right;uniform vec3 front;
#define CUSTOM_VERTEX_DEFINITIONS
void main(void) {
#define CUSTOM_VERTEX_MAIN_BEGIN
mat3 view=mat3(up,right,front);direction=view*vec3(position,1.0);gl_Position=vec4(position,0.0,1.0);
...
`;t.ShaderStore.ShadersStore[r]||(t.ShaderStore.ShadersStore[r]=i),e.s(["fluidRenderingParticleThicknessVertexShader",0,{name:r,shader:i}])},657921,e=>{"use strict";var t=e.i(868738),r=e.i(774685);class i extends t.FlowGraphEventBlock{constructor(){super(...arguments),this.initPriority=-1,this.type="SceneReady"}_executeEvent(e,t){return this._execute(e),!0}_preparePendingTasks(e){}_cancelPendingTasks(e){}getClassName(){return"FlowGraphSceneReadyEventBlock"}}(0,r.RegisterClass)("FlowGraphSceneReadyEventBlock",i),e.s(["FlowGraphSceneReadyEventBlock",0,i])},37022,e=>{"use strict";var t=e.i(263537);let r="blackAndWhitePixelShader",i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform degree: f32;
#define CUSTOM_FRAGMENT_DEFINITIONS
@fragment
...
`;t.ShaderStore.ShadersStore[a]||(t.ShaderStore.ShadersStore[a]=o),e.s(["boundingBoxRendererVertexShader",0,{name:a,shader:o}],436813)},605261,e=>{"use strict";var t=e.i(353679),r=e.i(916624),i=e.i(774685);class a extends t.FlowGraphExecutionBlockWithOutSignal{constructor(e){super(e),this.body=this.registerDataInput("body",r.RichTypeAny),this.force=this.registerDataInput("force",r.RichTypeVector3),this.location=this.registerDataInput("location",r.RichTypeVector3)}_execute(e,t){let r=this.body.getValue(e);if(!r){this._reportError(e,"No physics body provided"),this.out._activateSignal(e);return}let i=this.force.getValue(e),a=this.location.getValue(e);r.applyForce(i,a),this.out._activateSignal(e)}getClassName(){return"FlowGraphApplyForceBlock"}}(0,i.RegisterClass)("FlowGraphApplyForceBlock",a),e.s(["FlowGraphApplyForceBlock",0,a])},916052,e=>{"use strict";var t=e.i(263537);let r="pickingPixelShader",i=`#if defined(INSTANCES)
flat varying vMeshID: f32;
#else
uniform meshID: f32;
#endif
...
`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["lodPixelShaderWGSL",0,{name:r,shader:i}])},229082,e=>{"use strict";var t=e.i(263537);let r="pointCloudVertex",i=`#if defined(POINTSIZE) && !defined(WEBGPU)
gl_PointSize=pointSize;
#endif
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[r]||(t.ShaderStore.IncludesShadersStore[r]=i),e.s([])},121181,e=>{"use strict";var t=e.i(263537);let r="fluidRenderingStandardBlurPixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform filterSize: i32;uniform blurDir: vec2f;varying vUV: vec2f;@fragment
...
#include<logDepthVertex>
#define CUSTOM_VERTEX_MAIN_END
}`;t.ShaderStore.ShadersStoreWGSL[r]||(t.ShaderStore.ShadersStoreWGSL[r]=i),e.s(["spritesVertexShaderWGSL",0,{name:r,shader:i}])},12128,e=>{"use strict";var t=e.i(263537);let r="sharpenPixelShader",i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 sharpnessAmounts;
#define CUSTOM_FRAGMENT_DEFINITIONS
void main(void)
